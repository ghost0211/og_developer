...
export default withEnglishFallback({
  ...
  connection: {
    ...
    recognizeTab: "Riconoscimento automatico",
    recognizeHint: "Incolla il testo di configurazione esistente (URL JDBC, coppie chiave=valore o qualsiasi descrizione) qui sotto; il modello AI predefinito lo analizzerà e compilerà il modulo Informazioni di connessione.",
    recognizePlaceholder: "es. jdbc:opengauss://192.168.1.10:5432/postgres?user=gaussdb&password=xxx oppure host=... port=... user=... password=... database=...",
    recognizeButton: "Riconosci e compila",
    recognizeNoConfig: "Nessun modello AI configurato. Configuralo prima in Impostazioni → AI.",
    recognizeEmptyInput: "Incolla prima il testo di configurazione da riconoscere.",
    recognizeSuccess: "Riconosciuto e compilato. Controlla e prova la connessione.",
    recognizeSuccessHint: "Riconosciuto ✓ controlla prima di connetterti",
    recognizeInvalidOutput: "L'output del modello non conteneva un oggetto JSON valido",
  ...
  ai: {
    ...
    promptTemplateBuiltin: "Integrato",
    ...
    actions: {
      ...
      generatePlsql: "Genera PL/SQL",
      fixPlsqlError: "Correggi errore PL/SQL",
  ...
  contextMenu: {
    ...
    dropSequence: "Elimina sequenza",
    dropSynonym: "Elimina sinonimo",
    dropPackage: "Elimina pacchetto",
    dropPackageBody: "Elimina corpo pacchetto",
    dropType: "Elimina tipo",
    dropTypeBody: "Elimina corpo tipo",
    dropJob: "Elimina job",
    ...
    confirmDropSequenceTitle: "Elimina sequenza",
    confirmDropSequenceMessage: 'Si è sicuri di voler eliminare la sequenza "{name}"?',
    confirmDropSynonymTitle: "Elimina sinonimo",
    confirmDropSynonymMessage: 'Si è sicuri di voler eliminare il sinonimo "{name}"?',
    confirmDropPackageTitle: "Elimina pacchetto",
    confirmDropPackageMessage: 'Si è sicuri di voler eliminare il pacchetto "{name}"?',
    confirmDropTypeTitle: "Elimina tipo",
    confirmDropTypeMessage: 'Si è sicuri di voler eliminare il tipo "{name}"?',
    confirmDropJobTitle: "Elimina job",
    confirmDropJobMessage: 'Si è sicuri di voler eliminare il job "{name}"?',
    ...
    dropSequenceSuccess: 'Sequenza "{name}" eliminata',
    dropSynonymSuccess: 'Sinonimo "{name}" eliminato',
    dropPackageSuccess: 'Pacchetto "{name}" eliminato',
    dropPackageBodySuccess: 'Corpo del pacchetto "{name}" eliminato',
    dropTypeSuccess: 'Tipo "{name}" eliminato',
    dropTypeBodySuccess: 'Corpo del tipo "{name}" eliminato',
    dropJobSuccess: 'Job "{name}" eliminato',
  ...
  tree: {
    ...
    referencedBy: "Riferito da",
    typeAttributes: "Attributi",
    types: "Tipi",
    gridfs: "GridFS",
    buckets: "Buckets",
  },
  ...
  plDebug: {
    title: "Esegui debug di {name}",
    running: "In esecuzione",
    finished: "Terminato",
    error: "Errore",
    starting: "Avvio della sessione di debug in corso...",
    continue: "Continua",
    next: "Passo successivo",
    step: "Entra (Step into)",
    finish: "Esci (Step out)",
    refresh: "Aggiorna",
    stop: "Arresta debug",
    currentLine: "Riga {line}",
    locals: "Variabili",
    noLocals: "Nessuna variabile",
    backtrace: "Stack di chiamate",
    breakpoints: "Punti di interruzione",
    noBreakpoints: "Fai clic a sinistra del numero di riga per impostare un punto di interruzione",
    constVar: "Le costanti sono di sola lettura",
    editVar: "Fai clic per modificare il valore",
    setVarFailed: "Impossibile impostare la variabile {name}",
  },
  about: {
