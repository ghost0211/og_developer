...
export default withEnglishFallback({
  ...
  updates: {
    ...
    availableMessage: "ogdeveloper {latest} è disponibile. Stai usando la versione {current}.",
    upToDate: "ogdeveloper è aggiornato ({version}).",
    ...
    activeTasksBlockUpdate: "Ci sono {count} attività in esecuzione. Attendi che terminino prima di aggiornare ogdeveloper.",
    portableAutomaticUpdate: "ogdeveloper scaricherà lo ZIP portatile firmato, sostituirà solo ogdeveloper.exe dopo l'uscita e si riavvierà automaticamente. portable.ogdeveloper e i dati verranno mantenuti.",
  ...
  sidebar: {
    ...
    importDbx: "Importa Configurazione ogdeveloper",
  ...
  connection: {
    ...
    oracleTnsPathHint: "Il percorso viene letto dal backend ogdeveloper/Oracle Agent. Sul desktop è locale; su Web e Docker appartiene al server.",
    ...
    gaussdbConnectionModeNativeHint: "Usa il protocollo compatibile con PostgreSQL integrato in ogdeveloper per le modalità A/PG/Oracle di GaussDB.",
    ...
    agentJavaTooOld: "Questo driver richiede Java 21. Usa il JRE 21 gestito da ogdeveloper o seleziona un eseguibile Java 21 in Gestione Driver.",
    ...
    jdbcPluginHint: "Installa prima il plugin ogdeveloper JDBC, quindi importa il file JAR del driver JDBC del fornitore del database.",
    ...
    kafkaKerberosKeytabPlaceholder: "Percorso sulla macchina ogdeveloper Agent, ad esempio /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opzionale, percorso sulla macchina ogdeveloper Agent, ad esempio /etc/krb5.conf",
    kafkaKerberosPathHint: "I percorsi di keytab e krb5.conf vengono letti da ogdeveloper Agent e devono esistere sulla macchina in cui è in esecuzione ogdeveloper Agent; non vengono caricati file dal browser corrente.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} schede SQL che stai chiudendo hanno modifiche non salvate. ogdeveloper mostra attualmente "{title}". Salvare prima di continuare?',
    unsavedChangesAppCloseMessage: '"{title}" ha modifiche SQL non salvate che andranno perse se esci da ogdeveloper. Salvare prima di uscire?',
    unsavedChangesAppCloseMultipleMessage: '{count} schede SQL hanno modifiche non salvate. ogdeveloper mostra attualmente "{title}". Andranno perse se esci da ogdeveloper. Salvare prima di uscire?',
  ...
  configExport: {
    ...
    cryptoUnavailable: "L'importazione cifrata non è disponibile in questo contesto del browser. Usa HTTPS, localhost o ogdeveloper Desktop.",
  ...
  ai: {
    ...
    codexCliEnvReservedName: "{name} è gestita da ogdeveloper per MCP Server e non può essere impostata qui.",
    cliMcpRequiredTitle: "ogdeveloper MCP Server required",
    cliMcpRequiredDescription: "{provider} uses the ogdeveloper MCP Server to access database schema and query tools. Install it before using this provider in the AI assistant.",
    ...
    codexMcpRequiredTitle: "ogdeveloper MCP Server richiesto",
    codexMcpRequiredDescription: "Codex CLI usa il ogdeveloper MCP Server per accedere allo schema del database e agli strumenti di query. Installalo prima di usare Codex nell'assistente AI.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "È stata sovrascritta una variabile MCP gestita da ogdeveloper. Rimuovi le variabili DBX_MCP_* dalla configurazione del provider.",
      claudeCodeNotAuthenticated: "Claude Code CLI non è autenticato. Esegui `claude auth login` in un terminale e riprova.",
      claudeCodeMcpConfigInvalid: "Claude Code non ha potuto leggere o analizzare la configurazione MCP di ogdeveloper. Controlla la versione e il percorso di Claude Code CLI.",
      dbxMcpMissing: "Non è stata trovata un'installazione compatibile di ogdeveloper MCP Server. Controlla Impostazioni > MCP, quindi reinstalla o aggiorna.",
      claudeCodeMcpStartupFailed: "Claude Code ha caricato la configurazione MCP ma non ha potuto avviare ogdeveloper MCP Server. Controlla Impostazioni > MCP e i dettagli seguenti.",
      claudeCodeCommandLineTooLong: "Windows ha rifiutato il comando Claude Code perché troppo lungo. Aggiorna ogdeveloper e riprova usando il file MCP generato.",
      ...
      piAgentEnvReserved: "È stata sovrascritta una variabile Pi o MCP gestita da ogdeveloper. Rimuovi DBX_PI_* e DBX_MCP_* dalla configurazione.",
      ...
      piAgentMcpStartupFailed: "Pi non ha potuto avviare il bridge MCP ogdeveloper. Controlla Impostazioni > MCP e i dettagli seguenti.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT è selezionato, ogdeveloper omette quell'argomento in modo che il database utilizzi il valore predefinito della procedura.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Lo stato del cluster resta disponibile. ogdeveloper richiede /metrics direttamente all'endpoint etcd corrente; verifica che l'URL risultante sia raggiungibile dall'applicazione ogdeveloper.",
  ...
  sqlParameters: {
    title: "Parametri SQL",
    description: "Compila i valori per i segnaposto del template SQL. ogdeveloper li sostituisce prima di eseguire l'SQL.",
    name: "Parametro",
    syntax: "Sintassi",
    type: "Tipo",
    value: "Valore",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predefinito ogdeveloper",
    ...
    iconThemeDefaultDescription: "Utilizza l'icona colorata dell'app ogdeveloper.",
    iconThemeBlack: "Nero",
    iconThemeBlackDescription: "Usa il logo ogdeveloper nero nell'app.",
    ...
    showTrayIconDescription: "Se disattivato, non viene mostrata alcuna icona, ma la chiusura della finestra nasconderà comunque ogdeveloper in background.",
    quitOnClose: "Esci alla chiusura della finestra",
    quitOnCloseDescription: "Se attivato, il pulsante di chiusura termina completamente ogdeveloper invece di nasconderlo nella barra delle applicazioni.",
    ...
    closeActionQuit: "Esci da ogdeveloper",
    closeActionMinimize: "Riduci a icona",
    updateNotificationsEnabled: "Abilita promemoria aggiornamenti",
    updateNotificationsEnabledDescription: "Se disattivato, ogdeveloper non controllerà automaticamente gli aggiornamenti dell'app o dei driver e non mostrerà badge. I controlli manuali restano disponibili.",
    ...
    duckDbWorkerProcessIsolationDescription: "Esegue le query DuckDB in un processo worker separato. Se una query lunga non risponde all'annullamento, ogdeveloper può arrestare il processo worker per rilasciare il blocco del file di database.",
    duckDbWorkerMaxProcesses: "Worker DuckDB simultanei massimi",
    duckDbWorkerMaxProcessesDescription: "Limita quanti processi worker DuckDB ogdeveloper può eseguire contemporaneamente. Intervallo: 1-16. Predefinito: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Riavvia ogdeveloper affinché questa modifica abbia effetto.",
    restartDbx: "Riavvia ogdeveloper",
    restartDbxFailed: "Impossibile riavviare ogdeveloper: {error}",
    ...
    openTabsRestoreModeDescription: "Scegli come ogdeveloper ripristina le schede aperte l'ultima volta.",
    ...
    syncWebDavDescription: "Carica o ripristina uno snapshot di ogdeveloper, inclusa la libreria SQL salvata, da un servizio di archiviazione compatibile con WebDAV.",
    ...
    syncRemotePathDescription: "ogdeveloper creerà le cartelle superiori mancanti durante il caricamento.",
    syncSecretNotice: "Per impostazione predefinita, ogdeveloper sincronizza solo i dettagli e le impostazioni di connessione. Le password dei database, le password SSH, le password proxy, le stringhe di connessione e le chiavi API AI rimangono locali.",
    syncSecrets: "Sincronizza i segreti crittografati",
    syncSecretsDescription: "Se abilitato, ogdeveloper crittografa le password del database, le password SSH e le chiavi API AI prima di caricarle su WebDAV.",
    syncSecretsPassphrase: "Password di sincronizzazione",
    syncSecretsPassphraseDescription: "Questa password viene utilizzata solo per crittografare e ripristinare i dati sensibili. ogdeveloper non la salva; inseriscila nuovamente su ciascun dispositivo.",
    syncTest: "Verifica",
    syncUpload: "Carica",
    ...
    syncAutoUploadDescription: "Viene eseguito mentre ogdeveloper è aperto. I download richiedono ancora conferma manuale per evitare di sostituire SQL salvati localmente.",
    ...
    syncDownloadConfirm: "Scaricare e applicare lo snapshot ogdeveloper remoto? I metadati locali e i file SQL salvati verranno sostituiti.",
    apply: "Applica",
    ...
    sqlVariableSyntaxDescription: "Scegli quali sintassi di variabili e segnaposto ogdeveloper sostituisce prima di eseguire SQL, per tipo di database. Tutte abilitate per impostazione predefinita.",
    ...
    jdbcPlugin: "Plugin ogdeveloper JDBC",
    ...
    mcpTitle: "Server MCP",
    mcpDescription: "Verifica l'installazione e la versione del Server ogdeveloper MCP utilizzata da Claude Code, Cursor e altri agenti.",
    ...
    mcpConfigOptionsHint:
      "ogdeveloper controlla centralmente l'accesso alle connessioni e i permessi di esecuzione per tutti i client MCP. La configurazione generata contiene solo i parametri di runtime necessari per avviare il server MCP e collegarlo a questa istanza ogdeveloper, senza variabili di autorizzazione o ambito connessione.",
    mcpScopeConnection: "Connessioni consentite per MCP",
    mcpScopeConnectionDescription: "ogdeveloper espone a MCP solo le connessioni selezionate. Le modifiche si applicano a tutti i client MCP.",
    ...
    mcpExecutionModeDescription: "Scegli il livello di autorizzazione applicato da ogdeveloper a tutti i client MCP. Le impostazioni di lettura e scrittura del client non possono modificare questo livello.",
    ...
    mcpExecutionModeReadOnlyDescription: "Consente solo le richieste che ogdeveloper classifica come letture; blocca le scritture riconosciute e le modifiche alle connessioni. I permessi dell'account del database restano il limite di sicurezza finale.",
    ...
    mcpCapabilityDescription: "Queste sono operazioni rappresentative; le richieste che ogdeveloper non può classificare in modo affidabile richiedono l'accesso completo.",
    ...
    mcpDetectionTiming: "ogdeveloper esegue la verifica automaticamente all'apertura di questa pagina; usa di nuovo Verifica per aggiornare.",
    mcpNpmBoundary: "ogdeveloper verifica e spiega solo lo stato di MCP; l'installazione e gli aggiornamenti vengono comunque eseguiti tramite npm.",
    ...
    supportInfoAppVersion: "Versione ogdeveloper",
    ...
    syncSnippetMigrateLegacyConfirm: "ogdeveloper creerà prima una sostituzione crittografata, quindi eliminerà definitivamente lo snippet legacy in testo semplice {id}. L'operazione non può essere annullata. Continuare?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Impossibile rimuovere la vecchia directory JRE: {path}\nCause possibili:\n  - un processo ogdeveloper Agent / java sta ancora usando la directory\n  - l'antivirus la sta analizzando\nChiudi ogni processo che potrebbe usare la directory, oppure riavvia ogdeveloper e riprova.\n(errore originale: {error})",
    ...
    javaRuntimeManaged: "JRE gestito da ogdeveloper",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "I backup programmati vengono eseguiti quando ogdeveloper è aperto, anche se ridotto a icona nella barra delle applicazioni.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "es. my-events",
    cancel: "Annulla",
    create: "Crea",
    bind: "Collega",
    bindDialogTitle: "Collega a {name}",
    queueNamePlaceholder: "es. my-queue",
    exchangeNamePlaceholder: "es. my-events",
