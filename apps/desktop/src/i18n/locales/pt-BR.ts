...
export default withEnglishFallback({
  ...
  connection: {
    ...
    recognizeTab: "Reconhecimento automático",
    recognizeHint: "Cole o texto de configuração existente (URL JDBC, pares chave=valor ou qualquer descrição) abaixo; o modelo de IA padrão o analisará e preencherá o formulário de Informações da conexão.",
    recognizePlaceholder: "ex.: jdbc:opengauss://192.168.1.10:5432/postgres?user=gaussdb&password=xxx ou host=... port=... user=... password=... database=...",
    recognizeButton: "Reconhecer e preencher",
    recognizeNoConfig: "Nenhum modelo de IA configurado. Configure primeiro em Configurações → IA.",
    recognizeEmptyInput: "Cole primeiro o texto de configuração a ser reconhecido.",
    recognizeSuccess: "Reconhecido e preenchido. Revise e teste a conexão.",
    recognizeSuccessHint: "Reconhecido ✓ revise antes de conectar",
    recognizeInvalidOutput: "A saída do modelo não continha um objeto JSON válido",
  ...
  ai: {
    ...
    actions: {
      ...
      generatePlsql: "Gerar PL/SQL",
      fixPlsqlError: "Corrigir erro PL/SQL",
  ...
  contextMenu: {
    ...
    dropSequence: "Remover Sequência",
    dropSynonym: "Remover Sinônimo",
    dropPackage: "Remover Pacote",
    dropPackageBody: "Remover Corpo do Pacote",
    dropType: "Remover Tipo",
    dropTypeBody: "Remover Corpo do Tipo",
    dropJob: "Remover Job",
    ...
    confirmDropSequenceTitle: "Remover Sequência",
    confirmDropSequenceMessage: 'Tem certeza de que deseja remover a sequência "{name}"?',
    confirmDropSynonymTitle: "Remover Sinônimo",
    confirmDropSynonymMessage: 'Tem certeza de que deseja remover o sinônimo "{name}"?',
    confirmDropPackageTitle: "Remover Pacote",
    confirmDropPackageMessage: 'Tem certeza de que deseja remover o pacote "{name}"?',
    confirmDropTypeTitle: "Remover Tipo",
    confirmDropTypeMessage: 'Tem certeza de que deseja remover o tipo "{name}"?',
    confirmDropJobTitle: "Remover Job",
    confirmDropJobMessage: 'Tem certeza de que deseja remover o job "{name}"?',
    ...
    dropSequenceSuccess: 'Sequência "{name}" removida',
    dropSynonymSuccess: 'Sinônimo "{name}" removido',
    dropPackageSuccess: 'Pacote "{name}" removido',
    dropPackageBodySuccess: 'Corpo do pacote "{name}" removido',
    dropTypeSuccess: 'Tipo "{name}" removido',
    dropTypeBodySuccess: 'Corpo do tipo "{name}" removido',
    dropJobSuccess: 'Job "{name}" removido',
  ...
  tree: {
    ...
    synonyms: "Sinônimos",
    packages: "Pacotes",
    packageBodies: "Corpos de pacotes",
    jobs: "Jobs",
  ...
  plDebug: {
    ...
    finished: "Concluído",
    error: "Erro",
    starting: "Iniciando sessão de depuração...",
    continue: "Continuar",
    next: "Avançar",
    step: "Entrar",
    finish: "Sair",
    ...
    locals: "Variáveis",
    noLocals: "Nenhuma variável",
    backtrace: "Pilha de chamadas",
    breakpoints: "Pontos de interrupção",
    noBreakpoints: "Clique à esquerda do número da linha para definir um ponto de interrupção",
    constVar: "Constantes são somente leitura",
    editVar: "Clique para editar o valor",
    setVarFailed: "Falha ao definir a variável {name}",
  },
  about: {
