...
export default withEnglishFallback({
  ...
  updates: {
    ...
    availableMessage: "ogdeveloper {latest} está disponível. Você está usando {current}.",
    upToDate: "O ogdeveloper está atualizado ({version}).",
    ...
    activeTasksBlockUpdate: "Há {count} tarefa(s) em execução. Aguarde a conclusão antes de atualizar o ogdeveloper.",
    portableAutomaticUpdate: "O ogdeveloper baixará o ZIP portátil assinado, substituirá apenas o ogdeveloper.exe após sair e reiniciará automaticamente. O portable.ogdeveloper e os dados serão mantidos.",
  ...
  sidebar: {
    ...
    importDbx: "Importar Configuração ogdeveloper",
  ...
  connection: {
    ...
    oracleTnsPathHint: "O caminho é lido pelo backend do ogdeveloper/Oracle Agent. No desktop é local; no Web e Docker pertence ao servidor.",
    ...
    gaussdbConnectionModeNativeHint: "Usa o protocolo compatível com PostgreSQL integrado ao ogdeveloper para os modos A/PG/Oracle do GaussDB.",
    ...
    agentJavaTooOld: "Este driver requer Java 21. Use o JRE 21 gerenciado pelo ogdeveloper ou selecione um executável Java 21 no Gerenciador de Drivers.",
    ...
    jdbcPluginHint: "Instale primeiro o plugin JDBC do ogdeveloper e depois importe o JAR do driver JDBC do fornecedor do banco de dados.",
    ...
    kafkaKerberosKeytabPlaceholder: "Caminho na máquina do ogdeveloper Agent, por exemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, caminho na máquina do ogdeveloper Agent, por exemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Os caminhos do keytab e do krb5.conf são lidos pelo ogdeveloper Agent e devem existir na máquina onde o ogdeveloper Agent é executado; os arquivos não são enviados do navegador atual.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} abas SQL que você está fechando têm alterações não salvas. O ogdeveloper está mostrando "{title}" no momento. Salvar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tem alterações SQL não salvas que serão perdidas se você sair do ogdeveloper. Salvar antes de sair?',
    unsavedChangesAppCloseMultipleMessage: '{count} abas SQL têm alterações não salvas. O ogdeveloper está mostrando "{title}" no momento. Serão perdidas se você sair do ogdeveloper. Salvar antes de sair?',
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "O ogdeveloper não conseguiu identificar exatamente uma tabela de destino segura para gravar este resultado.",
      ...
      "metadata-unavailable": "O ogdeveloper não conseguiu carregar os metadados da tabela, portanto a edição do resultado está desabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "A importação criptografada não está disponível neste contexto do navegador. Use HTTPS, localhost ou ogdeveloper Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "ogdeveloper MCP Server obrigatório",
    codexMcpRequiredDescription: "O Codex CLI usa o ogdeveloper MCP Server para acessar o schema do banco e as ferramentas de consulta. Instale-o antes de usar o Codex no assistente de AI.",
    ...
    codexCliEnvReservedName: "{name} é gerenciada pelo ogdeveloper para o MCP Server e não pode ser definida aqui.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Uma variável MCP gerenciada pelo ogdeveloper foi sobrescrita. Remova as variáveis DBX_MCP_* da configuração do provedor.",
      ...
      claudeCodeMcpConfigInvalid: "O Claude Code não conseguiu ler ou analisar a configuração MCP do ogdeveloper. Verifique a versão e o caminho do executável do Claude Code CLI.",
      dbxMcpMissing: "Uma instalação compatível do ogdeveloper MCP Server não foi encontrada. Verifique Configurações > MCP e reinstale ou atualize.",
      claudeCodeMcpStartupFailed: "O Claude Code carregou a configuração MCP, mas não conseguiu iniciar o ogdeveloper MCP Server. Verifique Configurações > MCP e os detalhes abaixo.",
      claudeCodeCommandLineTooLong: "O Windows rejeitou o comando do Claude Code porque era muito longo. Atualize o ogdeveloper e tente novamente com o arquivo MCP gerado.",
      ...
      piAgentEnvReserved: "Uma variável Pi ou MCP gerenciada pelo ogdeveloper foi sobrescrita. Remova DBX_PI_* e DBX_MCP_* da configuração.",
      ...
      piAgentMcpStartupFailed: "O Pi não conseguiu iniciar a ponte MCP do ogdeveloper. Verifique Configurações > MCP e os detalhes abaixo.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Quando DEFAULT está marcado, o ogdeveloper omite esse argumento para que o banco de dados use o padrão do procedimento.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "O estado do cluster continua disponível. O ogdeveloper solicita /metrics diretamente ao endpoint etcd atual; confirme se a URL resultante pode ser acessada pelo aplicativo ogdeveloper.",
  ...
  sqlParameters: {
    ...
    description: "Preencha valores para marcadores de template SQL. O ogdeveloper substitui antes de executar o SQL.",
    name: "Parâmetro",
    syntax: "Sintaxe",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Padrão do ogdeveloper",
    ...
    iconThemeDefaultDescription: "Usar o ícone colorido do app ogdeveloper.",
    iconThemeBlack: "Preto",
    iconThemeBlackDescription: "Use o logo preto da ogdeveloper no app.",
    ...
    showTrayIconDescription: "Quando desativado, nenhum ícone é exibido, mas fechar a janela ainda oculta o ogdeveloper em segundo plano como antes.",
    quitOnClose: "Sair ao fechar a janela",
    quitOnCloseDescription: "Quando ativado, o botão de fechar encerra o ogdeveloper completamente em vez de minimizar para a bandeja.",
    ...
    closeActionQuit: "Sair do ogdeveloper",
    closeActionMinimize: "Minimizar para a bandeja",
    updateNotificationsEnabled: "Ativar lembretes de atualização",
    updateNotificationsEnabledDescription: "Quando desativado, o ogdeveloper não verificará automaticamente atualizações do app ou dos drivers nem mostrará indicadores. Verificações manuais continuam disponíveis.",
    ...
    duckDbWorkerProcessIsolationDescription: "Executa consultas DuckDB em um processo worker separado. Se uma consulta longa não responder ao cancelamento, o ogdeveloper pode encerrar o processo worker para liberar o bloqueio do arquivo de banco de dados.",
    duckDbWorkerMaxProcesses: "Máximo de workers simultâneos do DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita quantos processos worker do DuckDB o ogdeveloper pode executar ao mesmo tempo. Intervalo: 1-16. Padrão: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicie o ogdeveloper para que esta alteração entre em vigor.",
    restartDbx: "Reiniciar ogdeveloper",
    restartDbxFailed: "Falha ao reiniciar o ogdeveloper: {error}",
    ...
    openTabsRestoreModeDescription: "Escolha como o ogdeveloper restaura as abas que estavam abertas na última vez.",
    ...
    syncWebDavDescription: "Envie ou restaure um snapshot do ogdeveloper, incluindo a biblioteca SQL salva, a partir de um serviço de armazenamento compatível com WebDAV.",
    ...
    syncRemotePathDescription: "O ogdeveloper criará as pastas pai ausentes ao enviar.",
    syncSecretNotice: "Por padrão, o ogdeveloper sincroniza apenas detalhes de conexão e configurações. Senhas de banco de dados, senhas SSH, senhas de proxy, strings de conexão e chaves de API de IA permanecem locais.",
    syncSecrets: "Sincronizar segredos criptografados",
    syncSecretsDescription: "Quando ativado, o ogdeveloper criptografa senhas de banco de dados, senhas SSH e chaves de API de IA antes de enviá-las para o WebDAV.",
    syncSecretsPassphrase: "Senha de sincronização",
    syncSecretsPassphraseDescription: "Esta senha é usada apenas para criptografar e restaurar dados sensíveis. O ogdeveloper não a salva; digite-a novamente em cada dispositivo.",
    syncTest: "Testar",
    syncUpload: "Enviar",
    syncDownload: "Baixar",
    ...
    syncAutoUploadDescription: "Executa enquanto o ogdeveloper está aberto. Downloads ainda exigem confirmação manual para evitar substituir SQL salvos localmente.",
    ...
    syncDownloadConfirm: "Baixar e aplicar o snapshot remoto do ogdeveloper? Os metadados locais e os SQL salvos serão substituídos.",
    apply: "Aplicar",
    ...
    sqlVariableSyntaxDescription: "Escolha quais sintaxes de variáveis e espaços reservados o ogdeveloper substitui antes de executar SQL, por tipo de banco de dados. Todas ativadas por padrão.",
    ...
    jdbcPlugin: "Plugin JDBC do ogdeveloper",
    ...
    mcpDescription: "Verifique a instalação e a versão do Servidor MCP do ogdeveloper usado pelo Claude Code, Cursor e outros agentes.",
    ...
    mcpConfigOptionsHint:
      "O ogdeveloper controla centralmente o acesso às conexões e as permissões de execução para todos os clientes MCP. A configuração gerada contém apenas os parâmetros de execução necessários para iniciar o servidor MCP e conectá-lo a esta instância do ogdeveloper, sem variáveis de permissão ou escopo de conexão.",
    mcpScopeConnection: "Conexões permitidas para MCP",
    mcpScopeConnectionDescription: "O ogdeveloper expõe ao MCP apenas as conexões selecionadas. As alterações se aplicam a todos os clientes MCP.",
    ...
    mcpExecutionModeDescription: "Escolha o nível de permissão que o ogdeveloper aplica a todos os clientes MCP. As configurações de leitura e gravação do cliente não podem alterar este nível.",
    ...
    mcpExecutionModeReadOnlyDescription: "Permite apenas solicitações classificadas pelo ogdeveloper como leitura; bloqueia gravações reconhecidas e alterações de conexão. As permissões da conta do banco continuam sendo o limite de segurança final.",
    ...
    mcpCapabilityDescription: "Estas são operações representativas; solicitações que o ogdeveloper não consegue classificar com segurança exigem acesso completo.",
    ...
    mcpDetectionTiming: "O ogdeveloper verifica automaticamente quando esta página é aberta; use Verificar novamente para atualizar.",
    mcpNpmBoundary: "O ogdeveloper apenas verifica e explica o status do MCP; a instalação e as atualizações ainda são feitas pelo npm.",
    ...
    supportInfoAppVersion: "Versão do ogdeveloper",
    ...
    syncSnippetMigrateLegacyConfirm: "O ogdeveloper criará primeiro uma substituição criptografada e depois excluirá permanentemente o snippet legado em texto simples {id}. Esta ação não pode ser desfeita. Continuar?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Não foi possível remover o diretório JRE antigo: {path}\nCausas possíveis:\n  - um processo ogdeveloper Agent / java ainda está usando o diretório\n  - o antivírus está analisando o diretório\nFeche qualquer processo que possa estar usando o diretório, ou reinicie o ogdeveloper e tente novamente.\n(erro original: {error})",
    ...
    javaRuntimeManaged: "JRE gerenciada pelo ogdeveloper",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "O ogdeveloper executará backups agendados quando estiver aberto, inclusive quando minimizado na bandeja.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "ex.: my-events",
    cancel: "Cancelar",
    create: "Criar",
    bind: "Vincular",
    bindDialogTitle: "Vincular a {name}",
    queueNamePlaceholder: "ex.: my-queue",
    exchangeNamePlaceholder: "ex.: my-events",
