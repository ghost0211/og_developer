...
export const zhCNMessages = {
  ...
  statusBar: {
    ...
    noConnection: "无活动连接",
    schema: "Schema",
    schemaTooltip: "切换当前查询的 Schema",
    defaultSchema: "默认",
    autoCommit: "自动提交",
    manualTransaction: "手动事务",
    readOnly: "只读",
    readOnlyTooltip: "当前连接为只读连接",
    production: "生产库",
    productionTooltip: "当前数据库已标记为生产环境",
    executing: "正在执行 SQL…",
    lastExecution: "最近执行 {duration} · {rows} 行",
    noExecution: "暂无执行记录",
    cursor: "Ln {line}, Col {column}",
    cursorTooltip: "编辑器光标位置",
    encodingTooltip: "文件编码",
    lineEndingTooltip: "换行符格式",
    zoomTooltip: "界面缩放",
    zoomOut: "缩小",
    zoomIn: "放大",
  },
  ...
  projectFiles: {
    title: "项目文件",
    selectProject: "选择项目",
    noProject: "暂无项目，创建一个项目以浏览其文件",
    loadFailed: "项目目录不可用或无法读取",
    emptyFolder: "项目目录为空",
  },
  commandWindow: {
    title: "命令窗口",
    helpTitle: "openGauss 命令窗口帮助",
    describe: "描述指定表或视图",
    listTables: "列出当前模式下的所有用户表",
    listViews: "列出当前模式下的所有视图",
    listFunctions: "列出当前模式下的函数与存储过程",
    listSchemas: "列出所有 Schema 模式",
    listIndexes: "列出所有索引",
    listSequences: "列出所有序列",
    listRoles: "列出所有数据库用户与角色",
    connect: "切换当前数据库",
    timing: "开启或关闭执行耗时显示",
    listDatabases: "列出数据库",
    listExtensions: "列出已安装扩展",
    describeSqlPlus: "描述表结构（SQL*Plus 兼容）",
    showErrors: "显示最近一次 PL/SQL 编译报错",
    showUser: "显示当前连接用户",
    clearScreen: "清空终端屏幕",
    executeSql: "执行标准 SQL 语句（以分号 ; 或 / 结尾）",
    timingOff: "耗时显示已关闭。",
    timingOn: "耗时显示已开启。",
    userIs: "当前用户为“{user}”",
    connectedTo: "已连接到 {database}。",
    currentDatabase: "当前数据库为“{database}”。",
    connectedBanner: "正在连接：{name}（{database}），用户：{user}",
    welcomeHint: "输入 \\? 或 help 查看元命令；支持标准 SQL 和 PL/SQL 块执行。",
    copied: "已复制所有命令与输出日志",
    timingLabel: "耗时显示",
    copy: "复制",
    copyTitle: "复制终端输出",
    clear: "清屏",
    clearTitle: "清空屏幕（clear）",
    execute: "执行",
    quickTables: "表",
    quickViews: "视图",
    quickFunctions: "函数/过程",
    quickSchemas: "模式",
    quickHelp: "帮助",
    connection: "连接",
    switchedTo: "已切换到 {name}（{database}）。",
    database: "数据库",
    switchedDatabase: "已切换到数据库 {database}。",
    connecting: "正在连接...",
    executing: "执行中...",
    inputPlaceholder: "输入 SQL 或元命令；多行 PL/SQL 使用 Ctrl+Enter 执行",
    ok: "成功",
    rowsAffected: "成功（影响 {count} 行）",
    nullValue: "NULL",
    rowCount: "（{count} 行）",
    rowCountOne: "（1 行）",
    relationNotFound: "未找到关系“{name}”。",
    connectedMessage: "当前已连接到数据库“{database}”，用户为“{user}”。",
    time: "耗时：{ms} ms",
  },
  invalidObjects: {
    title: "例程健康分析",
    badge: "openGauss PL/SQL 维护",
    connection: "连接：",
    database: "数据库：",
    schema: "模式：",
    allSchemas: "全部模式",
    ...
    package: "包规范",
    packageBody: "包体",
    filterPlaceholder: "过滤名称 / 错误...",
    compiling: "编译中",
    fixed: "已修复",
    errorColumn: "编译报错信息（错误 / 行）",
    status: "状态",
    type: "类型",
    objectName: "对象名称",
    actions: "操作",
    compile: "编译",
    editSource: "在程序窗口中编辑源码",
    noConnections: "未检测到已配置的 PostgreSQL / openGauss 数据源",
    noConnectionsHint: "请先创建或保存 PostgreSQL / openGauss 连接，再打开例程健康分析。",
    loading: "正在查询 dbe_pldeveloper.gs_source 失效对象...",
    empty: "当前数据库未发现任何失效或编译报错的 PL 对象",
    emptyHint: "未发现编译失败记录；这不代表例程内部 SQL 已全部通过检查。",
    compileFailed: "编译失败",
    undefinedDependency: "未获取到详细编译错误",
    found: "共发现 {count} 个失效对象",
    selected: "（已勾选 {count} 个）",
    close: "关闭",
    recompileSelected: "重编译已选（{count}）",
    recompileAll: "全部重编译（{count}）",
    batchProgress: "正在批量重编译：{current} / {total}...",
    success: "成功：{count}",
    failed: "失败：{count}",
    scanEmptyToast: "未发现编译失败记录",
    scanFailed: "扫描失效对象失败：{message}",
    compileSuccess: "编译成功：{name}（{elapsed}ms）",
    compileError: "编译报错：{message}",
    compileException: "编译异常：{message}",
    batchComplete: "重编译完成：成功 {success} 个，失败 {failed} 个",
  },
  routineHealth: {
    businessSchemas: "全部业务模式",
    analyze: "重新分析",
    scopeHint: "只读分析例程源码与当前数据库目录。检查明确的表、字段、例程调用和索引引用；动态 SQL 等未能确认的部分会单独提示。未发现问题不代表运行必定成功。",
    issues: "问题与待确认",
    errors: "发现问题",
    review: "需人工确认",
    noFindings: "未发现问题",
    allResults: "全部结果",
    search: "搜索例程、依赖名称或分析结果…",
    summary: "已分析 {count} 个例程 · {errors} 条问题记录 · {review} 条待确认记录",
    scanFailed: "分析失败，未生成有效结果",
    schemaLoadFailed: "模式列表加载失败",
    coverage: "本次分析的覆盖范围",
    loading: "正在读取源码与依赖目录并分析…",
    noMatches: "当前筛选条件下没有结果",
    noRoutines: "当前范围没有可分析的例程或编译失败记录",
    emptyHint: "可切换到“全部结果”查看已检查的例程；请同时留意分析覆盖范围提示。",
    checkedHint: "本次静态检查未发现明确问题。",
    selectRecords: "选择可重新执行的编译记录",
    origin: "来源",
    analysis: "源码分析",
    compilation: "编译记录",
    routine: "例程 / 签名",
    ...
    noCompilerDetails: "存在创建或编译失败记录，但未获取到详细错误；不能据此确认当前对象有效性。",
    line: "第 {line} 行",
    viewRecordedSource: "查看记录源码",
    openRoutine: "打开例程",
    retry: "重新执行创建语句",
    retrySelected: "重新执行所选记录（{count}）",
    retryHint: "此操作会执行保存的创建 DDL，仅适用于编译失败记录。",
    retrySummary: "创建语句执行完成：{success} 成功，{failed} 失败。已重新分析。",
    analyzedAt: "分析时间 {time} · 修改例程后请重新分析",
    notAnalyzed: "尚未生成分析结果",
    findings: {
      missing_relation: "未找到引用的表或视图：{name}",
      missing_column: "未找到引用的字段：{name}",
      missing_routine: "未找到同名例程：{name}；需核实是否为类型转换或扩展语法。",
      missing_index: "未找到明确引用的索引：{name}",
      optional_index_missing: "索引 {name} 不存在，但该语句的 IF EXISTS 允许不存在。",
      dynamic_sql: "存在动态 SQL，其字符串中的依赖只能在运行时确定，未分析。",
      temporary_relation: "引用了临时表，其会话相关结构未完整检查。",
      unresolved_search_path: "search_path 无法静态确定；未判定未限定名称是否缺失。",
      unresolved_package_call: "包或多级限定调用未完整检查。",
      unsupported_language: "该例程使用的语言尚不支持静态分析。",
      unparsed_source: "无法取得可静态分析的例程体。",
  ...
  menus: {
    ...
    edit: "编辑",
    session: "会话",
    runTransaction: "执行与事务",
    executeCurrentStatement: "执行当前语句",
    view: "视图",
    search: "搜索",
    searchFiles: "搜索文件",
    searchMetadata: "搜索元数据",
    searchObjects: "搜索数据库对象",
    createProject: "创建项目",
    openProject: "打开项目",
    cloneFromGit: "从 Git 仓库克隆...",
    gitPanel: "源代码管理",
    recentProjects: "最近项目",
    undo: "撤销",
    redo: "重做",
    ...
    find: "查找",
    replace: "查找并替换",
    createProjectHint: "项目是一个命名的工作目录，用于文件搜索的默认根目录。",
    projectName: "项目名称",
    ...
    projectActivated: "已切换到项目",
    searchHint: "文件搜索在项目目录中按文件名匹配；元数据搜索数据库对象名称；对象搜索匹配存储过程/函数/视图的定义文本。",
    searchRootPlaceholder: "搜索根目录（默认为当前项目）",
    searchFileNamePlaceholder: "文件名关键词",
  ...
  projectHub: {
    ...
    newProjectHint: "在右侧打开项目创建表单",
    leftPanelHint: "在这里选择项目，右侧可查看或编辑；创建操作也在右侧完成。",
    searchPlaceholder: "搜索项目...",
    noProjects: "暂无项目",
    current: "当前",
    createTitle: "创建数据库项目",
    createDescription: "项目作为专属工作区，统一管理 SQL 脚本、查询与默认数据库连接。",
    createActionHint: "填写右侧表单后，点击下方“创建并激活项目”保存项目。",
    nameRequired: "项目名称 *",
    namePlaceholder: "例如：core-banking-system",
    pathRequired: "项目根工作目录 *",
    pathPlaceholder: "选择或输入本地文件夹路径",
    browse: "浏览...",
    parentDirectory: "上级目录",
    refreshDirectories: "刷新目录",
    useDirectory: "使用此目录",
    loadingDirectories: "正在加载目录...",
    noSubdirectories: "没有子目录",
    directoryListFailed: "无法读取目录：{message}",
    connectionOptional: "默认数据库连接（可选）",
    unboundConnection: "未绑定连接",
    unboundConnectionOption: "-- 未绑定连接 --",
    descriptionOptional: "项目说明（可选）",
    descriptionPlaceholder: "项目简要说明...",
    initializeFolders: "自动初始化标准子目录（queries/、scripts/、migrations/、ddl/、docs/）",
    createAndActivate: "创建并激活项目",
    cancel: "取消",
    activeProject: "当前活动项目",
    switchToCurrent: "切换为当前项目",
    removeProject: "移除项目",
    projectName: "项目名称",
    projectPath: "项目工作目录",
    changeDirectory: "更改...",
    openDirectory: "打开目录",
    boundConnection: "绑定的数据库连接",
    projectDescription: "项目说明",
    saveChanges: "保存属性修改",
    footerHint: "活动项目将作为全局文件搜索与新建脚本的默认工作区根目录。",
    close: "关闭",
    namePathRequired: "项目名称和目录路径不能为空。",
    pathAlreadyRegistered: "该目录已经登记为项目。",
    createDirectoryFailed: "初始化项目目录失败：{message}",
    directoryPickerFailed: "选择目录失败：{message}",
    openDirectoryFailed: "无法在系统文件管理器中打开目录。",
    desktopOnly: "该功能仅在桌面客户端可用。",
    projectSaved: "项目属性已保存。",
    projectActivated: "已切换至项目：{name}",
    projectRemoved: "已移除项目：{name}",
    removeConfirm: "确定要移除项目“{name}”吗？不会删除磁盘上的文件。",
  },
  updates: {
    title: "更新",
    check: "检查更新",
    availableTitle: "发现新版本",
    availableMessage: "OG Developer {latest} 已发布，当前版本为 {current}。",
    upToDate: "OG Developer 已是最新版本 ({version})。",
    failed: "检查更新失败：{error}",
    rateLimited: "GitHub 更新检查暂时触发频率限制。你仍然可以打开下载页手动查看。",
    openRelease: "打开下载页",
    downloadAndInstall: "下载并安装",
    activeTasksBlockUpdate: "有 {count} 个任务正在执行，请等待任务完成后再更新 OG Developer。",
    portableAutomaticUpdate: "OG Developer 将下载已签名的便携版 ZIP，退出后仅替换 ogdeveloper.exe 并自动重启。portable.ogdeveloper 和 data 会保留。",
  ...
  connection: {
    ...
    oracleTnsPathHint: "该路径由 OG Developer 后端/Oracle Agent 读取。桌面端填写本机路径，Web 和 Docker 部署填写服务器路径。",
    ...
    sslEnable: "启用加密连接",
    sslHint: "启用与数据库服务器的 SSL/TLS 加密传输",
    sslCaCert: "CA 证书",
    sslClientCert: "客户端证书",
    sslClientKey: "客户端私钥",
    caCertPath: "CA 证书",
    ...
    kafkaKerberosKeytabPlaceholder: "OG Developer Agent 所在机器路径，例如 /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "可选，OG Developer Agent 所在机器路径，例如 /etc/krb5.conf",
    kafkaKerberosPathHint: "keytab 和 krb5.conf 路径由 OG Developer Agent 读取，必须存在于运行 OG Developer Agent 的机器上；不会从当前浏览器上传文件。",
    ...
    gaussdbConnectionModeNativeHint: "使用 OG Developer 内置的 PostgreSQL 兼容协议，适用于 GaussDB 的 A/PG/Oracle 兼容模式。",
    ...
    identifierQuoteStyle: "标识符引用符号",
    identifierQuoteAuto: "自动（按驱动模式）",
    identifierQuoteDouble: "双引号",
    identifierQuoteBacktick: "反引号",
    ...
    agentJavaTooOld: "该驱动需要 Java 21。请在驱动管理器中使用 OG Developer 托管 JRE 21，或选择 Java 21 可执行文件。",
    ...
    aiRecognizeTitle: "智能识别连接信息",
    aiRecognizePlaceholder: "粘贴 JDBC URL、连接串或包含 host/port/user 的配置文本，例如：\njdbc:opengauss://127.0.0.1:5432/postgres?user=gaussdb&password=xxx",
    aiRecognizeAction: "识别并填入",
    aiRecognizeApplied: "已成功识别并应用连接配置",
    aiRecognizeFailed: "识别连接配置失败：{error}",
    transportType: "传输方式",
    transportNone: "直连（无隧道）",
    tunnel: "隧道",
    authMethod: "认证方式",
    authPassword: "密码",
    authKey: "私钥",
    authKeyAndPassword: "私钥 + 密码",
    privateKeyPath: "私钥路径",
    passphrase: "私钥密码 (Passphrase)",
    tunnelUrl: "隧道 URL",
    tunnelToken: "隧道 Token",
    sshTunnel: "隧道/代理",
    advancedTab: "高级",
    recognizeTab: "自动识别",
    recognizeHint: "将已有的连接配置文本（JDBC URL、键值对或任意描述）粘贴到下方，默认大模型会自动解析并填入“连接信息”表单。",
    recognizePlaceholder: "例如：jdbc:opengauss://192.168.1.10:5432/postgres?user=gaussdb&password=xxx，或 host=... port=... user=... password=... database=...",
    recognizeButton: "识别并填入",
    recognizeNoConfig: "尚未配置大模型，请先在 设置 → AI 中配置",
    recognizeEmptyInput: "请先粘贴需要识别的配置文本",
    recognizeSuccess: "识别成功，已自动填入连接信息，请核对后测试连接",
    recognizeSuccessHint: "已识别 ✓ 请核对后连接",
    recognizeInvalidOutput: "模型输出中未包含有效的 JSON 对象",
    sshEnable: "使用隧道/代理连接",
    sshHost: "SSH 主机",
    ...
    jdbcDocs: "查看 JDBC 文档",
    jdbcPluginHint: "先安装 OG Developer JDBC 插件。有外部依赖的驱动请从驱动管理使用 Maven 安装，或同时导入驱动及全部依赖 JAR。",
  ...
  editor: {
    ...
    unsavedChangesAppCloseMessage: "「{title}」有未保存的 SQL 更改，退出 OG Developer 后将丢失。是否保存后再退出？",
    unsavedChangesAppCloseMultipleMessage: "当前有 {count} 个 SQL 标签未保存，当前已定位到「{title}」。退出 OG Developer 后将丢失，是否保存后再退出？",
    ...
    searchContext: "搜索连接、数据库或模式...",
    contextConnections: "连接",
    contextDatabases: "数据库",
    contextSchemas: "模式",
  ...
  tabs: {
    ...
    resultSets: "语句结果",
    removeRun: "删除执行 {n}",
    autoKeepResults: "自动保留查询结果（开启后每次执行都会保留为新的结果标签页）",
    autoKeepResultsEnabled: "已开启自动保留结果：每次执行都会新增一个结果标签页，点击关闭",
  ...
  grid: {
    ...
    openColumnStatsDialog: "列数据统计",
    columnStatsTitle: "列数据统计：{column}",
    columnStatsScope: "基于当前已加载的 {count} 行结果",
    columnStatsTotalRows: "已加载行数",
    columnStatsNonNull: "非 NULL 数",
    columnStatsNull: "NULL 数",
    columnStatsDistinct: "唯一值数",
    columnStatsNumericSummary: "数值摘要",
    columnStatsMin: "最小值",
    columnStatsMax: "最大值",
    columnStatsAvg: "平均值",
    columnStatsSum: "总和",
    columnStatsTopValues: "高频值分布（非 NULL 占比）",
    columnStatsValueCount: "{count} 次（{percent}%）",
    columnStatsNoValues: "暂无可统计的数据",
    columnStatsEmptyString: "''（空字符串）",
    columnStatsClose: "关闭",
  ...
  welcome: {
    title: "数据库工作台",
    subtitle: "选择左侧连接开始浏览结构，或直接创建查询标签页。",
    connections: "连接",
    connected: "已连接",
  ...
  searchCenter: {
    ...
    placeholders: {
      objects: "搜索过程、函数、包及视图定义源码...",
      metadata: "搜索表、视图、过程、函数、包或字段名称...",
      files: "搜索项目文件名称或相对路径...",
      data: "输入要跨表查找的文本值、ID 或业务编号...",
    },
    filters: {
      all: "全部",
      table: "表",
    ...
    objectType: "对象类型：",
    connectionScope: "数据库配置：",
    selectConnections: "请选择数据库配置和数据库",
    selectedConnections: "已选择 {count} 个数据库目标",
    multipleConnectionHint: "可多选；仅搜索勾选的配置和数据库",
    allConnectedDatabases: "该配置的所有已连接数据库",
    singleConnectionHint: "跨表数据搜索每次选择一个数据库配置",
    selectAll: "全选",
    clearSelection: "清空",
    noSearchableConnections: "没有可用于当前搜索的数据库配置",
    connectionRequired: "请至少选择一个数据库配置。",
    partialConnectionFailure: "有 {count} 个所选数据库配置连接失败，已继续搜索其他配置。",
    projectRequired: "请先创建或激活项目，再搜索项目文件。",
    matchCount: "找到 {count} 条匹配结果 · 按 Enter 打开选中项",
    loadingSource: "正在检索所选数据库配置的对象源码...",
    sourceHint: "输入关键词，搜索过程、函数、包及视图源码。",
    noSourceResults: "没有对象源码包含“{query}”。",
    loadingMetadata: "正在搜索所选数据库配置的元数据...",
    metadataHint: "输入名称，查找表、视图、过程、函数、包及字段。",
    noMetadataResults: "没有匹配的元数据对象。",
    loadingFiles: "正在搜索项目文件...",
    filesHint: "输入活动项目中的文件名或相对路径。",
    noFileResults: "没有匹配的文件。",
    dataTitle: "跨表数据内容搜索",
    dataDescription: "使用“{query}”预填数据库扫描器，然后在所选数据库配置的各表文本兼容字段中搜索。",
    launchDataSearch: "打开跨表数据搜索",
    navigate: "切换",
    open: "打开",
    close: "关闭",
    targetRequired: "请先选择数据库连接和数据库，再搜索表数据。",
  },
  quickOpen: {
  ...
  tunnelProfiles: {
    useSharedProfile: "使用共享隧道配置",
    selectProfile: "选择隧道配置",
  ...
  configExport: {
    ...
    cryptoUnavailable: "当前浏览器环境不支持加密配置导入，请使用 HTTPS、localhost 或 OG Developer 桌面版。",
  ...
  ai: {
    ...
    proxyUrl: "代理地址",
    permissionLevel: "Agent 数据库权限",
    permissionLevelReadonly: "只读（默认）",
    permissionLevelData: "数据读写",
    permissionLevelFull: "完全（含 DDL）",
    permissionLevelDescription: "允许 AI Agent 在 Agent 模式下直接访问配置的数据库。只读仅允许 SELECT/SHOW/EXPLAIN；数据读写增加 INSERT/UPDATE/DELETE；完全权限再允许 DDL（CREATE/ALTER/DROP/TRUNCATE）。生产数据库无论此设置如何都强制只读。",
    ...
    knowledgeBaseEnabled: "openGauss 文档知识库",
    knowledgeBaseEnabledDescription: "AI 请求前检索内置的 openGauss 官方文档，把相关片段注入提示词，让回答符合 openGauss 真实的语法与行为。",
    ...
    codexCliEnvReservedName: "{name} 由 OG Developer 用于 MCP Server，不能在这里设置。",
    cliPath: "{provider} 路径",
    ...
    cliEnvReservedName: "{name} 由 OG Developer 用于 MCP Server，不能在这里设置。",
    codexMcpRequiredTitle: "需要 OG Developer MCP Server",
    codexMcpRequiredDescription: "Codex CLI 通过 OG Developer MCP Server 访问数据库结构和查询工具。请先安装后再在 AI 助手中使用 Codex。",
    reasoningLevel: "推理级别",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "配置覆盖了由 OG Developer 管理的 MCP 环境变量。请从供应商配置中移除 DBX_MCP_* 变量。",
      claudeCodeNotAuthenticated: "Claude Code CLI 尚未登录。请在终端执行 `claude auth login` 后重试。",
      claudeCodeMcpConfigInvalid: "Claude Code 无法读取或解析 OG Developer 生成的 MCP 配置。请检查 Claude Code CLI 版本和可执行文件路径。",
      dbxMcpMissing: "未找到兼容的 OG Developer MCP Server。请在 设置 > MCP 中检查并重新安装或更新。",
      claudeCodeMcpStartupFailed: "Claude Code 已加载 MCP 配置，但无法启动 OG Developer MCP Server。请检查 设置 > MCP 和下方诊断详情。",
      claudeCodeCommandLineTooLong: "Windows 拒绝了过长的 Claude Code 命令。请更新 OG Developer，并使用生成的 MCP 配置文件重试。",
      ...
      piAgentEnvReserved: "配置覆盖了由 OG Developer 管理的 Pi 或 MCP 环境变量。请移除 DBX_PI_* 和 DBX_MCP_* 变量。",
      piAgentNotAuthenticated: "Pi Coding Agent 没有可用的已认证模型供应商。请先在 Pi 中配置或登录供应商。",
      piAgentMcpStartupFailed: "Pi 无法启动 OG Developer 的作用域 MCP 桥接。请检查 设置 > MCP 和下方诊断详情。",
    ...
    actions: {
      ...
      generatePlsql: "生成 PL/SQL",
      fixPlsqlError: "修复 PL/SQL 错误",
  ...
  contextMenu: {
    ...
    createTrigger: "新建触发器",
    createJob: "新建作业",
    createScheduler: "新建调度",
    editJob: "编辑作业",
    editScheduler: "编辑调度",
    runJob: "立即运行",
    enableJob: "启用",
    disableJob: "禁用",
    runJobSuccess: "作业「{name}」已成功执行",
    runJobFailed: "作业执行失败：{message}",
    runJobTriggered: "作业「{name}」已触发，调度器将立即执行",
    runJobDisabled: "作业「{name}」已禁用，请先启用",
    runJobFailedGeneric: "执行失败，请查看作业失败信息",
    enableJobSuccess: "作业「{name}」已启用",
    disableJobSuccess: "作业「{name}」已禁用",
    createObject: "新建对象",
    dropTable: "删除表",
    emptyTable: "清空数据",
    truncateTable: "截断表",
    ...
    confirmDropSequenceTitle: "删除序列",
    confirmDropSequenceMessage: "确定要删除序列「{name}」吗？",
    confirmDropSynonymTitle: "删除同义词",
    confirmDropSynonymMessage: "确定要删除同义词「{name}」吗？",
    confirmDropPackageTitle: "删除包",
    confirmDropPackageMessage: "确定要删除包「{name}」吗？",
    confirmDropTypeTitle: "删除类型",
    confirmDropTypeMessage: "确定要删除类型「{name}」吗？",
    confirmDropJobTitle: "删除作业",
    confirmDropJobMessage: "确定要删除作业「{name}」吗？",
    confirmDropSchedulerTitle: "删除调度",
    confirmDropSchedulerMessage: "确定要删除调度「{name}」吗？",
    dropViewSuccess: "视图「{name}」已删除",
    dropProcedureSuccess: "存储过程「{name}」已删除",
    dropFunctionSuccess: "函数「{name}」已删除",
    dropSequenceSuccess: "序列「{name}」已删除",
    dropSynonymSuccess: "同义词「{name}」已删除",
    dropPackageSuccess: "包「{name}」已删除",
    dropPackageBodySuccess: "包体「{name}」已删除",
    dropTypeSuccess: "类型「{name}」已删除",
    dropTypeBodySuccess: "类型体「{name}」已删除",
    dropJobSuccess: "作业「{name}」已删除",
    dropSchedulerSuccess: "调度「{name}」已删除",
  ...
  processList: {
    ...
    copied: "已复制",
    cancelQuery: "取消查询",
    cancelConfirm: "确定取消会话 {id}（{user}）当前正在执行的查询？连接将保持打开状态。",
    cancelSuccess: "已取消会话 {id} 的当前查询",
    cancelFailed: "取消查询失败：{message}",
    blockingLocks: "锁与阻塞分析",
    resourceLocks: "资源锁详情",
    allSessions: "所有会话",
    blockingSource: "阻塞源会话",
    blockedTarget: "被阻塞会话",
    noBlockingLocks: "当前未检测到锁阻塞链路。",
    blockingAlert: "检测到 {count} 条锁阻塞链路",
    sessionInspector: "会话详细信息",
    openInSqlEditor: "在 SQL 编辑器中打开",
    grantCopied: "已复制授权 SQL: {sql}",
    monitorUnsupported: "当前连接类型暂不支持会话监控：{type}",
    copyGrantSql: "复制授权 SQL",
    ownSessionOnlyHint: "当前用户 {user} 仅能查看自身会话。openGauss 安全策略要求 monadmin（监控管理员）或 sysadmin 角色方可查看全库所有用户的进程与 SQL。",
    statTotal: "总会话数",
    statActive: "活跃查询",
    statWaiting: "锁等待中",
    statIdleInXact: "事务中空闲",
    statMaxTime: "最长耗时",
    filterAll: "全部",
    filterActive: "活跃",
    filterWaiting: "等待锁",
    filterIdleInXact: "事务空闲",
    clickRowHint: "点击行可查看完整 SQL 及会话详情",
    cancelQueryTitle: "取消当前执行中的查询",
    cancelShort: "取消",
    killShort: "终止",
    sessionDetails: "会话详情 (PID: {pid})",
    elapsed: "耗时",
    copySql: "复制 SQL",
    noActiveSql: "-- 暂无活跃 SQL",
    noBlockingTitle: "数据库当前运行顺畅，未检测到锁阻塞链路",
    noBlockingDesc: "所有事务正常获取并释放锁，无死锁或排他锁阻塞情况。",
    blockingHint: "以下会话正在等待排他锁，可选择一键终止阻塞源会话以解除阻塞。",
    colRelation: "锁定对象 (Relation)",
    colLockMode: "锁模式 (Lock Mode)",
    colWaitTime: "等待时长",
    blockingSourceShort: "阻塞源",
    waitingFor: "等待: {mode}",
    killBlockingSource: "终止阻塞源",
    resourceLockSummary: "其他会话资源锁清单 (共 {count} 条记录)",
    resourceLockScopeHint: "当前连接自身的锁不列入此页",
    noOtherResourceLocks: "当前没有其他会话持有资源锁",
    colLockType: "锁类型",
    colLockModeShort: "锁模式 (Mode)",
    colGranted: "状态 (Granted)",
    colRelatedQuery: "关联查询",
    lockGranted: "已持有",
    lockWaiting: "等待中",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "集群状态仍可正常查看。OG Developer 会直接访问当前 etcd endpoint 拼接后的 /metrics，请确认该地址可由 OG Developer 应用访问。",
  ...
  plDebug: {
    ...
    refresh: "刷新",
    stop: "停止调试",
    currentLine: "当前行 {line}",
    locals: "变量",
    noLocals: "无变量",
    backtrace: "调用栈",
    breakpoints: "断点",
    noBreakpoints: "点击代码行号左侧可设断点",
    constVar: "常量不可修改",
    editVar: "点击编辑变量值",
  ...
  production: {
    title: "生产环境",
    markerHint: "标记为生产环境，执行破坏性或高风险操作时将弹出二次确认",
    connection: "生产连接",
    enable: "启用生产环境保护",
  ...
  sqlParameters: {
    title: "SQL 参数",
    description: "为 SQL 模板占位符填写参数值，OG Developer 会在执行前替换为 SQL 字面量。",
    name: "参数名",
    syntax: "Syntax",
    type: "类型",
    value: "参数值",
  ...
  sessions: {
    title: "会话管理",
    description: "当前所有已连接数据库的后端会话；可手动刷新、定时自动刷新或终止会话。",
    refresh: "刷新",
    autoRefresh: "定时刷新",
    autoRefreshOff: "关闭",
    user: "用户",
    ...
    kill: "结束会话",
    killed: "会话已终止",
    killConfirm: "确认终止会话 PID {pid}（{user}）？正在执行的查询将被中断。",
    empty: "没有发现会话",
  },
  settings: {
    title: "设置",
    ...
    securityTab: "安全",
    aboutTab: "关于我们",
    aboutDescription: "openGauss 专用数据库开发工具。基于 OG Developer 构建，内置官方 JDBC 驱动，提供 PL/SQL 开发、调试与对象管理一体化体验。",
    fontFamily: "字体",
    dataGridFontFamily: "查询结果网格字体",
    dataGridFontFamilyDescription: "用于查询结果、表数据、列标题和单元格内编辑器。",
    uiFontFamily: "界面字体",
    uiFontAppDefault: "OG Developer 默认",
    ...
    quitOnCloseDescription: "开启后，点击窗口关闭按钮将彻底退出 OG Developer，而不是隐藏到系统托盘。",
    ...
    updateNotificationsEnabledDescription: "关闭后，OG Developer 不会自动检查应用和驱动更新，也不会显示更新红点；仍可手动检查更新。",
    updateDownloadSource: "更新下载源",
    updateDownloadSourceDescription: "选择数据库 Agent、驱动和托管 JRE 的下载来源。官方源为推荐选项，CNB 适合国内网络环境。应用更新始终从 GitHub Releases 检查与下载。",
    ...
    duckDbWorkerProcessIsolationDescription: "将 DuckDB 查询放到独立 worker 进程中运行。停止长查询时，如果 DuckDB 未及时响应取消请求，OG Developer 会结束 worker 进程以释放数据库文件锁。",
    duckDbWorkerMaxProcesses: "DuckDB 最大并发 worker 数",
    duckDbWorkerMaxProcessesDescription: "限制 OG Developer 同时运行的 DuckDB worker 进程数量。范围：1-16，默认：4。",
    duckDbWorkerProcessIsolationRestartRequired: "重启 OG Developer 后生效。",
    restartDbx: "重启 OG Developer",
    restartDbxFailed: "重启 OG Developer 失败：{error}",
    debugLogsCopy: "复制日志",
    debugLogsCopied: "已复制",
    ...
    openTabsRestoreModeDescription: "选择 OG Developer 启动时如何恢复上次打开的标签页。",
    ...
    shortcutSearchObjectSource: "搜索对象源码",
    shortcutSearchMetadata: "搜索数据库元数据",
    shortcutSearchTableData: "跨表搜索数据库内容",
    ...
    jdbcPlugin: "OG Developer JDBC 插件",
    ...
    supportInfoAppVersion: "OG Developer 版本",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows: "无法删除旧的 JRE 目录：{path}\n可能的原因：\n  - 仍有 OG Developer Agent / java 进程占用该目录\n  - 防病毒软件正在扫描\n请关闭可能持有该目录的进程，或重启 OG Developer 后重试。\n（原始错误：{error}）",
    ...
    javaRuntimeManaged: "OG Developer 托管 JRE",
  ...
  mqExchanges: {
    ...
    virtualHost: "虚拟主机",
    namePlaceholder: "例如 my-events",
    cancel: "取消",
    create: "创建",
    bind: "绑定",
    bindDialogTitle: "绑定到 {name}",
    queueNamePlaceholder: "例如 my-queue",
    exchangeNamePlaceholder: "例如 my-events",
  ...
  jobDialog: {
    createJobTitle: "新建作业 (Classic Job)",
    createSchedulerTitle: "新建调度 (DBMS_SCHEDULER)",
    editJobTitle: "编辑作业 - #{id}",
    editSchedulerTitle: "编辑调度 - {name}",
    classicJobTab: "经典作业 (pkg_service)",
    schedulerTab: "高级调度 (DBMS_SCHEDULER)",
    jobName: "任务名称 / 标识",
    autoJobIdHint: "系统自动分配自增 Job ID",
    targetSchema: "所属模式 (Schema)",
    actionType: "作业类型 (Job Type)",
    enabledLabel: "立即激活 (Enabled)",
    enabledDesc: "创建后按设定周期自动调度",
    actionContent: "执行内容 / SQL 逻辑 (Action)",
    actionHint: "推荐使用带 Schema 的全限定调用",
    scheduleSection: "调度规则与时间设置",
    startDate: "首次执行时间 (Start Date)",
    repeatInterval: "重复间隔 (Repeat Interval)",
    sqlPreview: "实时 DDL / SQL 预览",
    openInEditor: "在 SQL 编辑器中打开",
    jobCreateSuccess: "经典作业已创建成功 (ID: {id})",
    schedulerCreateSuccess: "调度任务「{name}」创建成功",
    jobUpdateSuccess: "作业/调度「{name}」已保存修改",
  },
  git: {
    title: "源代码管理",
    panelTitle: "源代码管理：Git",
    cloneFromGit: "从 Git 仓库克隆...",
    cloneTitle: "从 Git 仓库克隆",
    clone: "克隆",
    cloning: "正在克隆仓库...",
    cloneSuccess: "仓库克隆成功",
    cloneFailed: "克隆仓库失败",
    ...
    urlRequired: "请输入仓库地址",
    targetDir: "目标目录",
    targetDirPlaceholder: "选择目标目录",
    targetDirRequired: "请选择目标目录",
    browse: "浏览...",
    username: "账号（可选）",
    usernamePlaceholder: "可选账号",
    token: "个人访问令牌 / 密码（可选）",
    tokenPlaceholder: "可选访问令牌或密码",
    branch: "分支（可选）",
    branchPlaceholder: "留空使用默认分支",
    notRepo: "当前活动项目不是 Git 仓库",
    noProject: "未选择活动项目",
    desktopOnly: "Git 功能仅在桌面端可用",
    notFound: "未检测到 Git，请先安装",
    branchSelect: "切换分支",
    newBranch: "新建分支...",
    newBranchTitle: "新建分支",
