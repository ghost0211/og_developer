...
export default withEnglishFallback({
  ...
  invalidObjects: {
    ...
    noConnections: "未检测到已配置的 openGauss / GaussDB 数据源",
    noConnectionsHint: "请先创建或保存 openGauss 连接，再打开无效对象维护中心。",
    loading: "正在查询 dbe_pldeveloper.gs_source 失效对象...",
    empty: "当前数据库未发现任何失效或编译报错的 PL 对象",
    emptyHint: "所有存储过程、函数、包规范与包体编译状态均为有效（VALID）。",
    compileFailed: "编译失败",
    undefinedDependency: "未定义依赖对象或编译语法错误",
    ...
    success: "成功：{count}",
    failed: "失败：{count}",
    scanEmptyToast: "未检测到失效对象，所有 PL/SQL 对象编译状态良好",
