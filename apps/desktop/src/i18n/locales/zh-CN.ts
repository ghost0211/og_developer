...
export default withEnglishFallback({
  ...
  searchCenter: {
    ...
    objectType: "对象类型：",
    connectedScopeHint: "源码和元数据搜索当前覆盖已连接的 PostgreSQL/openGauss 系列数据库，并支持 JDBC 配置。",
    projectRequired: "请先创建或激活项目，再搜索项目文件。",
    matchCount: "找到 {count} 条匹配结果 · 按 Enter 打开选中项",
    loadingSource: "正在检索已连接数据库的对象源码...",
    sourceHint: "输入关键词，搜索过程、函数、包及视图源码。",
    noSourceResults: "没有对象源码包含“{query}”。",
    loadingMetadata: "正在搜索已连接数据库的元数据...",
    ...
    dataTitle: "跨表数据内容搜索",
    dataDescription: "使用“{query}”预填数据库扫描器，然后在活动数据库各表的文本兼容字段中搜索。",
