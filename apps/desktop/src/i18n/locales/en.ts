export default {
  ...
  invalidObjects: {
    ...
    noConnections: "No configured openGauss / GaussDB data source found",
    noConnectionsHint: "Create or save an openGauss connection before opening the invalid-object maintenance center.",
    ...
    emptyHint: "All procedures, functions, package specifications, and package bodies are valid (VALID).",
    compileFailed: "Compilation failed",
    undefinedDependency: "Undefined dependency or compilation syntax error",
    ...
    failed: "Failed: {count}",
    scanEmptyToast: "No invalid objects found; all PL/SQL objects are valid",
