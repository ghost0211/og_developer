export default {
  ...
  settings: {
    ...
    syncWebDavDescription: "Upload or restore a ogdeveloper snapshot, including saved SQL library entries, from a WebDAV-compatible storage service.",
    ...
    syncRemotePathDescription: "ogdeveloper will create missing parent folders when uploading.",
    syncSecretNotice: "By default, ogdeveloper syncs connection details and settings only. Database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, connection strings, and AI API keys stay local.",
    syncSecrets: "Sync encrypted secrets",
    syncSecretsDescription: "When enabled, ogdeveloper encrypts database passwords, SSH passwords, proxy passwords, HTTP tunnel tokens, and AI API keys before uploading them to remote storage.",
    ...
    syncSecretsPassphraseDescription: "This password is only used to encrypt and restore sensitive data. ogdeveloper does not save it; enter it again on each device.",
    syncTest: "Test",
    syncUpload: "Upload",
    ...
    syncAutoUploadDescription: "Runs while ogdeveloper is open. Downloads still require manual confirmation to avoid replacing local saved SQL unexpectedly.",
    ...
    syncDownloadConfirm: "Download and apply the remote ogdeveloper snapshot? Local metadata and saved SQL will be replaced.",
    syncSnippetTitle: "GitHub / Gitee Snippet Sync",
    syncSnippetDescription: "Store the same ogdeveloper snapshot in a private code snippet. The first upload creates a snippet and saves its ID.",
    ...
    syncSnippetMigrateLegacyConfirm: "ogdeveloper will first create an encrypted replacement, then permanently delete legacy plaintext snippet {id}. This cannot be undone. Continue?",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Check the ogdeveloper MCP Server installation and version used by Claude Code, Cursor, and other agents.",
    ...
    mcpConfigOptionsHint: "ogdeveloper centrally controls connection access and execution permissions for every MCP client. Generated configs contain only the runtime settings needed to start the MCP server and connect to this ogdeveloper instance, with no permission or connection-scope variables.",
    mcpScopeConnection: "Connections allowed for MCP",
    mcpScopeConnectionDescription: "ogdeveloper exposes only the selected connections to MCP. Changes apply to every MCP client.",
    ...
    mcpExecutionModeDescription: "Choose the permission level ogdeveloper enforces for every MCP client. Client-side read/write settings cannot change this level.",
    ...
    mcpExecutionModeReadOnlyDescription: "Allows only requests ogdeveloper classifies as reads; blocks recognized database writes and connection changes. Database-account permissions remain the final hard boundary.",
    ...
    mcpCapabilityDescription: "These are representative operations; requests ogdeveloper cannot classify reliably require full access.",
    ...
    mcpDetectionTiming: "ogdeveloper checks automatically when this page opens; use Check again to refresh.",
    mcpNpmBoundary: "ogdeveloper only checks and explains MCP status; installation and upgrades still run through npm.",
