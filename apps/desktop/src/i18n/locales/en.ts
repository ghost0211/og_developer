export default {
  ...
  searchCenter: {
    ...
    connectedScopeHint: "Source and metadata search currently covers connected PostgreSQL/openGauss-family databases, including JDBC profiles.",
    ...
    dataDescription: "Open the database scanner with “{query}” prefilled, then search text-compatible columns across tables in the active database.",
