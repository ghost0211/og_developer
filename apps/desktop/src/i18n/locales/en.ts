export default {
  ...
  statusBar: {
    label: "IDE status bar",
    noConnection: "No active connection",
    schema: "Schema",
    schemaTooltip: "Switch the schema for the active query",
    defaultSchema: "Default",
    autoCommit: "Auto commit",
    manualTransaction: "Manual transaction",
    readOnly: "Read-only",
    readOnlyTooltip: "This connection is read-only",
    production: "Production",
    productionTooltip: "The active database is marked as production",
    executing: "Executing SQL…",
    lastExecution: "Last execution {duration} · {rows} rows",
    noExecution: "No recent execution",
    cursor: "Ln {line}, Col {column}",
    cursorTooltip: "Editor cursor position",
    encodingTooltip: "File encoding",
    lineEndingTooltip: "Line ending format",
    zoomTooltip: "Interface zoom",
    zoomOut: "Zoom out",
    zoomIn: "Zoom in",
  },
  activityBar: {
  ...
  projectFiles: {
    ...
    noProject: "No project yet. Create a project to browse its files.",
    loadFailed: "Project directory is unavailable or cannot be read",
    emptyFolder: "Project directory is empty",
  },
  commandWindow: {
    title: "Command Window",
    helpTitle: "openGauss Command Window Help",
    describe: "Describe a table or view",
    listTables: "List tables in the current schema",
    listViews: "List views in the current schema",
    listFunctions: "List functions and procedures in the current schema",
    listSchemas: "List schemas",
    listIndexes: "List indexes",
    listSequences: "List sequences",
    listRoles: "List database users and roles",
    connect: "Switch the current database",
    timing: "Show or hide execution timing",
    listDatabases: "List databases",
    listExtensions: "List installed extensions",
    describeSqlPlus: "Describe a table (SQL*Plus compatible)",
    showErrors: "Show the latest PL/SQL compilation errors",
    showUser: "Show the current connection user",
    clearScreen: "Clear the terminal screen",
    executeSql: "Execute a standard SQL statement (ending with ; or /)",
    timingOff: "Timing is off.",
    timingOn: "Timing is on.",
    userIs: 'USER is "{user}"',
    connectedTo: "Connected to {database}.",
    currentDatabase: 'Current database is "{database}".',
    connectedBanner: "Connecting to: {name} ({database}) as {user}",
    welcomeHint: "Type \\? or help for meta commands. Standard SQL and PL/SQL blocks are supported.",
    copied: "All commands and output logs copied",
    timingLabel: "Timing",
    copy: "Copy",
    copyTitle: "Copy terminal output",
    clear: "Clear",
    clearTitle: "Clear screen (clear)",
    execute: "Execute",
    quickTables: "Tables",
    quickViews: "Views",
    quickFunctions: "Functions/Procedures",
    quickSchemas: "Schemas",
    quickHelp: "Help",
    connection: "Connection",
    switchedTo: "Switched to {name} ({database}).",
    database: "Database",
    switchedDatabase: "Switched to database {database}.",
    connecting: "Connecting...",
    executing: "Executing...",
    inputPlaceholder: "Enter SQL or a meta command; use Ctrl+Enter for multi-line PL/SQL",
    ok: "OK",
    rowsAffected: "OK ({count} rows affected)",
    nullValue: "NULL",
    rowCount: "({count} rows)",
    rowCountOne: "(1 row)",
    relationNotFound: 'Did not find any relation named "{name}".',
    connectedMessage: 'You are now connected to database "{database}" as user "{user}".',
    time: "Time: {ms} ms",
  },
  invalidObjects: {
    title: "Routine Health Analysis",
    badge: "openGauss PL/SQL Maintenance",
    connection: "Connection:",
    database: "Database:",
    schema: "Schema:",
    allSchemas: "All schemas",
    scan: "Scan invalid objects",
    allTypes: "All types",
    procedure: "Procedure",
    function: "Function",
    package: "Package specification",
    packageBody: "Package body",
    filterPlaceholder: "Filter name / error...",
    compiling: "Compiling",
    fixed: "Fixed",
    errorColumn: "Compilation error (Error / Line)",
    status: "Status",
    type: "Type",
    objectName: "Object name",
    actions: "Actions",
    compile: "Compile",
    editSource: "Edit source in program window",
    noConnections: "No configured PostgreSQL / openGauss data source found",
    noConnectionsHint: "Create or save a PostgreSQL / openGauss connection before opening routine health analysis.",
    loading: "Querying invalid objects in dbe_pldeveloper.gs_source...",
    empty: "No invalid or compilation-error PL/SQL objects found in the current database",
    emptyHint: "No compilation failure records found. SQL inside routines has not necessarily been validated.",
    compileFailed: "Compilation failed",
    undefinedDependency: "Detailed compilation error unavailable",
    found: "Found {count} invalid objects",
    selected: "({count} selected)",
    close: "Close",
    recompileSelected: "Recompile selected ({count})",
    recompileAll: "Recompile all ({count})",
    batchProgress: "Batch recompiling: {current} / {total}...",
    success: "Success: {count}",
    failed: "Failed: {count}",
    scanEmptyToast: "No compilation failure records found",
    scanFailed: "Failed to scan invalid objects: {message}",
    compileSuccess: "Compiled successfully: {name} ({elapsed}ms)",
    compileError: "Compilation error: {message}",
    compileException: "Compilation exception: {message}",
    batchComplete: "Recompilation complete: {success} succeeded, {failed} failed",
  },
  routineHealth: {
    businessSchemas: "All business schemas",
    analyze: "Analyze again",
    scopeHint: "Read-only analysis of routine source and the current database catalog. Checks explicit table, column, routine and index references; unresolved paths such as dynamic SQL are reported separately. No findings does not guarantee successful execution.",
    issues: "Issues and review items",
    errors: "Issues found",
    review: "Needs review",
    noFindings: "No findings",
    allResults: "All results",
    search: "Search routines, dependencies or findings…",
    summary: "{count} routines analyzed · {errors} issue records · {review} review records",
    scanFailed: "Analysis failed; no valid results generated",
    schemaLoadFailed: "Failed to load schemas",
    coverage: "Analysis coverage",
    loading: "Reading routine source and dependency catalogs…",
    noMatches: "No results match the current filters",
    noRoutines: "No routines or compilation failure records in this scope",
    emptyHint: "Select All results to view checked routines, and review the coverage notes.",
    checkedHint: "No definite issues found by this static check.",
    selectRecords: "Select compilation records to retry",
    origin: "Source",
    analysis: "Source analysis",
    compilation: "Compiler record",
    routine: "Routine / signature",
    results: "Findings",
    compilationFailed: "Compilation failed",
    noCompilerDetails: "A creation or compilation failure was recorded, but details are unavailable. This does not establish the current object's validity.",
    line: "Line {line}",
    viewRecordedSource: "View recorded source",
    openRoutine: "Open routine",
    retry: "Run CREATE again",
    retrySelected: "Retry selected records ({count})",
    retryHint: "Executes the saved CREATE DDL; applies only to compilation failure records.",
    retrySummary: "CREATE completed: {success} succeeded, {failed} failed. Analysis refreshed.",
    analyzedAt: "Analyzed at {time} · Analyze again after editing routines",
    notAnalyzed: "No analysis results yet",
    findings: {
      missing_relation: "Referenced table or view not found: {name}",
      missing_column: "Referenced column not found: {name}",
      missing_routine: "No routine named {name} found; check whether this is a type conversion or extension syntax.",
      missing_index: "Explicitly referenced index not found: {name}",
      optional_index_missing: "Index {name} does not exist, which is allowed by IF EXISTS.",
      dynamic_sql: "Dynamic SQL found; dependencies inside the string were not analyzed.",
      temporary_relation: "A temporary relation is referenced; its session-dependent structure was not fully checked.",
      unresolved_search_path: "search_path cannot be determined statically; unqualified names were not judged as missing.",
      unresolved_package_call: "Package or multi-level qualified call was not fully checked.",
      unsupported_language: "Static analysis is not supported for this routine language.",
      unparsed_source: "A statically analyzable routine body could not be obtained.",
  ...
  menus: {
    ...
    searchObjects: "Search Object Definitions",
    createProject: "Create Project",
    openProject: "Open Project",
    cloneFromGit: "Clone from Git Repository...",
    ...
    createProjectHint: "A project is a named working directory used as the default root for file search.",
    ...
    searchHint: "File search matches file names inside the project directory; metadata search looks up database object names; object search scans procedure/function/view definition text.",
    searchRootPlaceholder: "Search root (defaults to the active project)",
    searchFileNamePlaceholder: "File name keyword",
    ...
    saveSql: "Save SQL",
    saveSqlAs: "Save As",
    importResult: "Import result archive",
  ...
  projectHub: {
    ...
    newProjectHint: "Open the project creation form on the right",
    leftPanelHint: "Select a project here to view or edit it on the right. Creation is completed on the right.",
    searchPlaceholder: "Search projects...",
    noProjects: "No projects",
    current: "Current",
    createTitle: "Create a database project",
    createDescription: "Use a project as a dedicated workspace for SQL scripts, queries, and a default database connection.",
    createActionHint: "Fill in the form and click “Create and activate” below to save the project.",
    nameRequired: "Project name *",
    namePlaceholder: "Example: core-banking-system",
    pathRequired: "Project root directory *",
    pathPlaceholder: "Choose or enter a local folder path",
    browse: "Browse...",
    ...
    directoryListFailed: "Could not list this directory: {message}",
    connectionOptional: "Default database connection (optional)",
    unboundConnection: "No connection",
    unboundConnectionOption: "-- No connection --",
    descriptionOptional: "Project description (optional)",
    descriptionPlaceholder: "Short project description...",
    initializeFolders: "Initialize standard subdirectories (queries/, scripts/, migrations/, ddl/, docs/)",
    createAndActivate: "Create and activate",
    cancel: "Cancel",
    activeProject: "Active project",
    switchToCurrent: "Set as current project",
    removeProject: "Remove project",
    projectName: "Project name",
    projectPath: "Project directory",
    changeDirectory: "Change...",
    openDirectory: "Open directory",
    boundConnection: "Bound database connection",
    projectDescription: "Project description",
    saveChanges: "Save changes",
    footerHint: "The active project is used as the default root for file search and new scripts.",
    close: "Close",
    namePathRequired: "Project name and directory are required.",
    pathAlreadyRegistered: "A project is already registered for this directory.",
    createDirectoryFailed: "Could not initialize the project directory: {message}",
    directoryPickerFailed: "Directory picker failed: {message}",
    openDirectoryFailed: "Could not open the directory in the system file manager.",
    desktopOnly: "This action is available in the desktop client only.",
    projectSaved: "Project properties saved.",
    projectActivated: "Switched to project: {name}",
    projectRemoved: "Removed project: {name}",
    removeConfirm: "Remove project '{name}'? Files on disk will not be deleted.",
  },
  updates: {
    title: "Updates",
    check: "Check for updates",
    availableTitle: "Update available",
    availableMessage: "OG Developer {latest} is available. You are using {current}.",
    upToDate: "OG Developer is up to date ({version}).",
    ...
    activeTasksBlockUpdate: "{count} task(s) are still running. Wait for them to finish before updating OG Developer.",
    portableAutomaticUpdate: "OG Developer will download the signed portable ZIP, replace only ogdeveloper.exe after exit, and restart automatically. portable.ogdeveloper and data will be kept.",
  ...
  sidebar: {
    ...
    importDbx: "Import OG Developer Config",
  ...
  connection: {
    ...
    oracleTnsPathHint: "The OG Developer backend/Oracle agent reads this path. Desktop paths are local; Web and Docker paths are on the server.",
    ...
    sslHint: "Enable SSL/TLS encrypted connection to the database server",
    sslCaCert: "CA Certificate",
    sslClientCert: "Client Certificate",
    sslClientKey: "Client Private Key",
    ...
    kafkaKerberosKeytabPlaceholder: "Path on OG Developer Agent machine, e.g. /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Optional path on OG Developer Agent machine, e.g. /etc/krb5.conf",
    kafkaKerberosPathHint: "The keytab and krb5.conf paths are read by OG Developer Agent and must exist on the machine running OG Developer Agent; files are not uploaded from this browser.",
    ...
    gaussdbConnectionModeNativeHint: "Uses OG Developer's built-in PostgreSQL-compatible protocol for GaussDB A/PG/Oracle compatibility modes.",
    ...
    identifierQuoteStyle: "Identifier Quote Style",
    identifierQuoteAuto: "Auto (by driver mode)",
    identifierQuoteDouble: "Double Quotes",
    identifierQuoteBacktick: "Backticks",
    ...
    agentJavaTooOld: "This driver requires Java 21. Use OG Developer managed JRE 21 or select a Java 21 executable in Driver Manager.",
    ...
    aiRecognizeTitle: "AI Connection Recognition",
    aiRecognizePlaceholder: "Paste a JDBC URL, connection string, or config text with host/port/user, e.g.:\njdbc:opengauss://127.0.0.1:5432/postgres?user=gaussdb&password=xxx",
    aiRecognizeAction: "Recognize and Apply",
    aiRecognizeApplied: "Connection configuration recognized and applied",
    aiRecognizeFailed: "Failed to recognize connection configuration: {error}",
    transportType: "Transport Type",
    transportNone: "None (Direct)",
    tunnel: "Tunnel",
    authMethod: "Authentication Method",
    authPassword: "Password",
    authKey: "Private Key",
    authKeyAndPassword: "Private Key + Password",
    ...
    recognizeTab: "Auto Recognize",
    recognizeHint: "Paste an existing connection config (JDBC URL, key=value pairs, or any description); the default AI model will parse it and fill the Connection Info form.",
    recognizePlaceholder: "e.g. jdbc:opengauss://192.168.1.10:5432/postgres?user=gaussdb&password=xxx, or host=... port=... user=... password=... database=...",
    recognizeButton: "Recognize & Fill",
    recognizeNoConfig: "No AI model configured yet. Set one up in Settings → AI first.",
    recognizeEmptyInput: "Paste the config text to recognize first.",
    recognizeSuccess: "Recognized and filled in. Review and test the connection.",
    recognizeSuccessHint: "Recognized ✓ review before connecting",
    recognizeInvalidOutput: "The model output did not contain a valid JSON object.",
    ...
    jdbcPluginHint: "Install the OG Developer JDBC plugin first. For drivers with external dependencies, install from Maven in Driver Manager or import the driver and all dependency JARs together.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} SQL tabs you are closing have unsaved changes. OG Developer is currently showing "{title}". Save before continuing?',
    unsavedChangesAppCloseMessage: '"{title}" has unsaved SQL changes that will be lost if you quit OG Developer. Save before quitting?',
    unsavedChangesAppCloseMultipleMessage: '{count} SQL tabs have unsaved changes. OG Developer is currently showing "{title}". Save before quitting?',
    ...
    searchContext: "Search connections, databases, or schemas...",
    contextConnections: "Connections",
    contextDatabases: "Databases",
    contextSchemas: "Schemas",
  ...
  tabs: {
    ...
    autoKeepResults: "Auto-keep query results (each execution is kept as a new result tab)",
    autoKeepResultsEnabled: "Auto-keep results is on: every execution adds a new result tab. Click to turn off",
  ...
  grid: {
    ...
    openColumnStatsDialog: "Open Column Statistics",
    columnStatsTitle: "Column Statistics — {column}",
    columnStatsScope: "Based on the {count} currently loaded rows",
    columnStatsTotalRows: "Loaded rows",
    columnStatsNonNull: "Non-NULL values",
    columnStatsNull: "NULL values",
    columnStatsDistinct: "Distinct values",
    columnStatsNumericSummary: "Numeric summary",
    columnStatsMin: "Minimum",
    columnStatsMax: "Maximum",
    columnStatsAvg: "Average",
    columnStatsSum: "Sum",
    columnStatsTopValues: "Most frequent values",
    columnStatsValueCount: "{count} ({percent}%)",
    columnStatsNoValues: "No values to summarize",
    columnStatsEmptyString: "'' (empty string)",
    columnStatsClose: "Close",
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "OG Developer could not identify exactly one safe writeback target table for this result.",
      ...
      "metadata-unavailable": "OG Developer could not load table metadata, so result editing is disabled.",
    },
  ...
  searchCenter: {
    title: "Search Center",
    menuSource: "Find in Object Source",
    menuTableData: "Search Table Data...",
    modes: {
      source: "Source",
      metadata: "Metadata",
      files: "Project Files",
    ...
    placeholders: {
      objects: "Search procedures, functions, packages, and view definitions...",
      metadata: "Search table, view, routine, package, or column names...",
      files: "Search project file names or relative paths...",
      data: "Enter a text value, ID, or business key to find across tables...",
    },
    filters: {
      all: "All",
      table: "Tables",
    ...
    connectionScope: "Database profiles:",
    selectConnections: "Select database profiles and databases",
    selectedConnections: "{count} database targets selected",
    multipleConnectionHint: "Select one or more profile/database targets; only checked targets are searched",
    allConnectedDatabases: "All connected databases for this profile",
    singleConnectionHint: "Table data search uses one database profile at a time",
    selectAll: "Select all",
    clearSelection: "Clear",
    noSearchableConnections: "No database profiles support this search mode",
    connectionRequired: "Select at least one database profile.",
    partialConnectionFailure: "{count} selected database profiles could not connect; the remaining profiles were still searched.",
    projectRequired: "Create or activate a project before searching project files.",
    matchCount: "{count} matching results · use Enter to open the selected item",
    loadingSource: "Searching object definitions in the selected database profiles...",
    sourceHint: "Enter a keyword to search routine, package, and view source.",
    noSourceResults: "No object source contains “{query}”.",
    loadingMetadata: "Searching metadata in the selected database profiles...",
    metadataHint: "Enter a name to find tables, views, routines, packages, and columns.",
    noMetadataResults: "No matching metadata objects.",
    loadingFiles: "Searching project files...",
    filesHint: "Enter a file name or relative path in the active project.",
    noFileResults: "No matching files.",
    dataTitle: "Cross-table data search",
    dataDescription: "Open the database scanner with “{query}” prefilled, then search text-compatible columns in the selected database profile.",
    launchDataSearch: "Open table data search",
    navigate: "Navigate",
    open: "Open",
    close: "Close",
    targetRequired: "Select a database connection and database before searching table data.",
  },
  quickOpen: {
  ...
  tunnelProfiles: {
    useSharedProfile: "Use Shared Profile",
  ...
  configExport: {
    ...
    cryptoUnavailable: "Encrypted config import is unavailable in this browser context. Use HTTPS, localhost, or OG Developer Desktop.",
  ...
  ai: {
    ...
    proxyUrl: "Proxy URL",
    permissionLevel: "Agent database permission",
    permissionLevelReadonly: "Read-only (default)",
    permissionLevelData: "Data read/write",
    permissionLevelFull: "Full (incl. DDL)",
    permissionLevelDescription: "Grants the AI agent direct database access in Agent mode. Read-only only allows SELECT/SHOW/EXPLAIN; Data adds INSERT/UPDATE/DELETE; Full also allows DDL (CREATE/ALTER/DROP/TRUNCATE). Production databases are always read-only regardless of this setting.",
    ...
    knowledgeBaseEnabled: "openGauss Docs Knowledge Base",
    knowledgeBaseEnabledDescription: "Search the built-in openGauss official documentation and inject relevant snippets into AI requests, so answers follow the real openGauss syntax and behavior.",
    ...
    codexCliEnvReservedName: "{name} is managed by OG Developer for the MCP server and cannot be set here.",
    ...
    cliEnvReservedName: "{name} is managed by OG Developer for the MCP server and cannot be set here.",
    codexMcpRequiredTitle: "OG Developer MCP Server required",
    codexMcpRequiredDescription: "Codex CLI uses the OG Developer MCP Server to access database schema and query tools. Install it before using Codex in the AI assistant.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "An OG Developer-managed MCP environment variable was overridden. Remove DBX_MCP_* variables from the provider configuration.",
      claudeCodeNotAuthenticated: "Claude Code CLI is not authenticated. Run `claude auth login` in a terminal and try again.",
      claudeCodeMcpConfigInvalid: "Claude Code could not read or parse the OG Developer MCP configuration. Check the Claude Code CLI version and executable path.",
      dbxMcpMissing: "A compatible OG Developer MCP Server installation was not found. Check Settings > MCP, then reinstall or update it.",
      claudeCodeMcpStartupFailed: "Claude Code loaded the MCP configuration but could not start OG Developer MCP Server. Check Settings > MCP and the diagnostics below.",
      claudeCodeCommandLineTooLong: "Windows rejected the Claude Code command because it was too long. Update OG Developer and retry using the generated MCP configuration file.",
      ...
      piAgentEnvReserved: "An OG Developer-managed Pi or MCP environment variable was overridden. Remove DBX_PI_* and DBX_MCP_* variables from the provider configuration.",
      ...
      piAgentMcpStartupFailed: "Pi could not start the scoped OG Developer MCP bridge. Check Settings > MCP and the diagnostics below.",
    ...
    actions: {
      ...
      generatePlsql: "Generate PL/SQL",
      fixPlsqlError: "Fix PL/SQL Error",
    ...
    promptTemplateBuiltin: "Built-in",
  ...
  contextMenu: {
    ...
    enableJob: "Enable",
    disableJob: "Disable",
    runJobSuccess: 'Job "{name}" executed successfully',
    runJobFailed: "Failed to run job: {message}",
    runJobTriggered: 'Job "{name}" triggered; the scheduler will run it shortly',
    runJobDisabled: 'Job "{name}" is disabled; enable it first',
    runJobFailedGeneric: "execution failed; check the job failure message",
    enableJobSuccess: 'Job "{name}" enabled',
    disableJobSuccess: 'Job "{name}" disabled',
    ...
    noParameters: "No parameters found for this routine",
    ...
    parameterDefaultHint: "When DEFAULT is checked, OG Developer omits that argument so the database uses the procedure default.",
    ...
    dropType: "Drop Type",
    dropTypeBody: "Drop Type Body",
    dropJob: "Drop Job",
    dropScheduler: "Drop Scheduler",
    ...
    confirmDropSynonymTitle: "Drop Synonym",
    confirmDropSynonymMessage: 'Are you sure you want to drop synonym "{name}"?',
    confirmDropPackageTitle: "Drop Package",
    confirmDropPackageMessage: 'Are you sure you want to drop package "{name}"?',
    confirmDropTypeTitle: "Drop Type",
    confirmDropTypeMessage: 'Are you sure you want to drop type "{name}"?',
    confirmDropJobTitle: "Drop Job",
    confirmDropJobMessage: 'Are you sure you want to drop job "{name}"?',
    confirmDropSchedulerTitle: "Drop Scheduler",
    confirmDropSchedulerMessage: 'Are you sure you want to drop scheduler "{name}"?',
    dropViewSuccess: 'View "{name}" dropped',
    dropProcedureSuccess: 'Procedure "{name}" dropped',
    dropFunctionSuccess: 'Function "{name}" dropped',
    dropSequenceSuccess: 'Sequence "{name}" dropped',
    dropSynonymSuccess: 'Synonym "{name}" dropped',
    dropPackageSuccess: 'Package "{name}" dropped',
    dropPackageBodySuccess: 'Package body "{name}" dropped',
    dropTypeSuccess: 'Type "{name}" dropped',
    dropTypeBodySuccess: 'Type body "{name}" dropped',
    dropJobSuccess: 'Job "{name}" dropped',
    dropSchedulerSuccess: 'Scheduler "{name}" dropped',
  ...
  processList: {
    ...
    cancelConfirm: "Cancel the running query for session {id} ({user})? The connection will stay open.",
    cancelSuccess: "Query for session {id} cancelled",
    cancelFailed: "Failed to cancel query: {message}",
    blockingLocks: "Locks & Blocking",
    resourceLocks: "Resource Locks",
    allSessions: "All Sessions",
    blockingSource: "Blocking Session",
    blockedTarget: "Blocked Session",
    noBlockingLocks: "No lock blocking chains detected.",
    blockingAlert: "{count} Blocking Lock Chains Detected",
    sessionInspector: "Session Details",
    openInSqlEditor: "Open in SQL Editor",
    grantCopied: "Grant SQL copied: {sql}",
    monitorUnsupported: "Session monitoring is not supported for this connection type: {type}",
    copyGrantSql: "Copy grant SQL",
    ownSessionOnlyHint: "Current user {user} can only see their own sessions. openGauss security policy requires the monadmin (monitor admin) or sysadmin role to view processes and SQL of all users.",
    statTotal: "Total Sessions",
    statActive: "Active Queries",
    statWaiting: "Waiting Locks",
    statIdleInXact: "Idle in Transaction",
    statMaxTime: "Longest Running",
    filterAll: "All",
    filterActive: "Active",
    filterWaiting: "Waiting",
    filterIdleInXact: "Idle in Txn",
    clickRowHint: "Click a row to view the full SQL and session details",
    cancelQueryTitle: "Cancel the currently running query",
    cancelShort: "Cancel",
    killShort: "Kill",
    sessionDetails: "Session Details (PID: {pid})",
    elapsed: "Duration",
    copySql: "Copy SQL",
    noActiveSql: "-- no active SQL",
    noBlockingTitle: "Database is running smoothly, no lock blocking chains detected",
    noBlockingDesc: "All transactions acquired and released locks normally; no deadlocks or exclusive-lock blocking.",
    blockingHint: "The sessions below are waiting for exclusive locks. Kill the blocking session to resolve.",
    colRelation: "Relation",
    colLockMode: "Lock Mode",
    colWaitTime: "Wait Time",
    blockingSourceShort: "Blocker",
    waitingFor: "Waiting: {mode}",
    killBlockingSource: "Kill Blocker",
    resourceLockSummary: "Resource locks held by other sessions ({count} records)",
    resourceLockScopeHint: "Locks of the current connection are not listed here",
    noOtherResourceLocks: "No resource locks held by other sessions",
    colLockType: "Lock Type",
    colLockModeShort: "Mode",
    colGranted: "Granted",
    colRelatedQuery: "Query",
    lockGranted: "Granted",
    lockWaiting: "Waiting",
  ...
  etcd: {
    ...
    access: {
      ...
      permissionUpdateHint: "etcd Auth has no atomic update. Saving revokes the old permission and then grants the new one. If granting fails, OG Developer attempts to restore the old permission.",
      saveChanges: "Save changes",
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Cluster status remains available. OG Developer requests /metrics directly from the current etcd endpoint; verify that the resulting URL is reachable from the OG Developer application.",
  ...
  plDebug: {
    ...
    locals: "Variables",
    noLocals: "No variables",
    backtrace: "Call stack",
    breakpoints: "Breakpoints",
    noBreakpoints: "Click left of a line number to set a breakpoint",
    constVar: "Constants are read-only",
    editVar: "Click to edit the value",
    setVarFailed: "Failed to set variable {name}",
  },
  about: {
    title: "About",
  ...
  production: {
    ...
    markerHint: "Mark as production environment; destructive or high-risk operations will require confirmation",
  ...
  sqlParameters: {
    ...
    description: "Fill values for SQL template placeholders. OG Developer replaces them before executing the SQL.",
    name: "Parameter",
    syntax: "Syntax",
    type: "Type",
    value: "Value",
  ...
  sessions: {
    title: "Sessions",
    description: "Backend sessions across connected databases — refresh manually, poll automatically, or terminate a session.",
    refresh: "Refresh",
    autoRefresh: "Auto refresh",
    autoRefreshOff: "Off",
    user: "User",
    ...
    killConfirm: "Terminate session PID {pid} ({user})? Running queries will be interrupted.",
  ...
  settings: {
    ...
    aboutTab: "About",
    aboutDescription: "A dedicated database development tool for openGauss. Built on OG Developer, ships the official JDBC driver, and provides integrated PL/SQL development, debugging, and object management.",
    ...
    uiFontAppDefault: "OG Developer Default",
    ...
    showTrayIconDescription: "When disabled, no icon is shown, but closing the window still hides OG Developer in the background as before.",
    quitOnClose: "Quit when closing window",
    quitOnCloseDescription: "When enabled, clicking the close button exits OG Developer completely instead of hiding it to the tray. You can change this later in Appearance settings.",
    ...
    closeActionQuit: "Quit OG Developer",
    closeActionMinimize: "Minimize to tray",
    updateNotificationsEnabled: "Enable update reminders",
    updateNotificationsEnabledDescription: "When disabled, OG Developer will not automatically check app or driver updates or show update badges. Manual checks are still available.",
    updateDownloadSource: "Update download source",
    updateDownloadSourceDescription: "Choose where database agents, drivers, and managed JREs are downloaded from. The official source is recommended; CNB can be faster on mainland China networks. App updates are always checked and downloaded from GitHub Releases.",
    ...
    duckDbWorkerProcessIsolationDescription: "Runs DuckDB queries in a separate worker process. If a long query does not respond to cancellation, OG Developer can stop the worker process to release the database file lock.",
    duckDbWorkerMaxProcesses: "DuckDB max concurrent workers",
    duckDbWorkerMaxProcessesDescription: "Limits how many DuckDB worker processes OG Developer can run at the same time. Range: 1-16. Default: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Restart OG Developer for this change to take effect.",
    restartDbx: "Restart OG Developer",
    restartDbxFailed: "Failed to restart OG Developer: {error}",
    ...
    openTabsRestoreModeDescription: "Choose how OG Developer restores tabs that were open last time.",
    ...
    sqlVariableSyntaxDescription: "Choose which variable and placeholder syntaxes OG Developer substitutes before running SQL, per database type. All are enabled by default.",
    ...
    shortcutSearchObjectSource: "Search object source",
    shortcutSearchMetadata: "Search database metadata",
    shortcutSearchTableData: "Search table data across the database",
    ...
    jdbcPlugin: "OG Developer JDBC plugin",
    ...
    supportInfoAppVersion: "OG Developer Version",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Failed to remove the old JRE directory: {path}\nPossible causes:\n  - an OG Developer Agent / java process still holds the directory\n  - antivirus software is scanning it\nClose any process that may hold the directory, or restart OG Developer and try again.\n(original error: {error})",
    ...
    javaRuntimeManaged: "OG Developer managed JRE",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "e.g. my-events",
    cancel: "Cancel",
    create: "Create",
    bind: "Bind",
    bindDialogTitle: "Bind to {name}",
    queueNamePlaceholder: "e.g. my-queue",
    exchangeNamePlaceholder: "e.g. my-events",
  ...
  jobDialog: {
    createJobTitle: "Create Job (Classic Job)",
    createSchedulerTitle: "Create Scheduler (DBMS_SCHEDULER)",
    editJobTitle: "Edit Job - #{id}",
    editSchedulerTitle: "Edit Scheduler - {name}",
    classicJobTab: "Classic Job (pkg_service)",
    schedulerTab: "Scheduler (DBMS_SCHEDULER)",
    jobName: "Job Name / Identifier",
    autoJobIdHint: "Auto-assigned numeric Job ID",
    targetSchema: "Schema",
    actionType: "Job Type",
    enabledLabel: "Enabled",
    enabledDesc: "Automatically scheduled upon creation",
    actionContent: "Action / SQL Logic",
    actionHint: "Fully qualified routine calls recommended",
    scheduleSection: "Schedule & Timing",
    startDate: "Start Date",
    repeatInterval: "Repeat Interval",
    sqlPreview: "Live DDL / SQL Preview",
    openInEditor: "Open in SQL Editor",
    jobCreateSuccess: "Classic job created successfully (ID: {id})",
    schedulerCreateSuccess: 'Scheduler "{name}" created successfully',
    jobUpdateSuccess: 'Job/Scheduler "{name}" updated successfully',
  },
  git: {
    title: "Source Control",
    panelTitle: "Source Control: Git",
    cloneFromGit: "Clone from Git...",
    cloneTitle: "Clone from Git Repository",
    clone: "Clone",
    cloning: "Cloning repository...",
    cloneSuccess: "Repository cloned successfully",
    cloneFailed: "Failed to clone repository",
    url: "Repository URL",
    urlPlaceholder: "https://dev.azure.com/company/project/_git/repo",
    urlRequired: "Repository URL is required",
    targetDir: "Target Directory",
    targetDirPlaceholder: "Select target directory",
    targetDirRequired: "Target directory is required",
    browse: "Browse...",
    username: "Username (Optional)",
    usernamePlaceholder: "Optional username",
    token: "Personal Access Token / Password (Optional)",
    tokenPlaceholder: "Optional PAT or password",
    branch: "Branch (Optional)",
    branchPlaceholder: "Default branch if empty",
    notRepo: "The active project is not a Git repository",
    noProject: "No active project selected",
    desktopOnly: "Git features are only available in the desktop app",
    notFound: "Git is not installed or not found on PATH. Please install Git first.",
    branchSelect: "Switch Branch",
    newBranch: "New Branch...",
    newBranchTitle: "Create New Branch",
    ...
    changes: "Changes",
    noChanges: "No changes detected in working tree",
    stage: "Stage Changes",
    stageAll: "Stage All Changes",
    unstage: "Unstage Changes",
    unstageAll: "Unstage All Changes",
    stageFailed: "Failed to stage changes",
    unstageFailed: "Failed to unstage changes",
    ...
    noStagedToCommit: "No staged changes to commit",
    diffTitle: "Git Diff",
