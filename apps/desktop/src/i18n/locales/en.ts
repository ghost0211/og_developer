export default {
  ...
  updates: {
    ...
    availableMessage: "ogdeveloper {latest} is available. You are using {current}.",
    upToDate: "ogdeveloper is up to date ({version}).",
    ...
    activeTasksBlockUpdate: "{count} task(s) are still running. Wait for them to finish before updating ogdeveloper.",
    portableAutomaticUpdate: "ogdeveloper will download the signed portable ZIP, replace only ogdeveloper.exe after exit, and restart automatically. portable.ogdeveloper and data will be kept.",
  ...
  sidebar: {
    ...
    importDbx: "Import ogdeveloper Config",
  ...
  connection: {
    ...
    oracleTnsPathHint: "The ogdeveloper backend/Oracle agent reads this path. Desktop paths are local; Web and Docker paths are on the server.",
    ...
    kafkaKerberosKeytabPlaceholder: "Path on ogdeveloper Agent machine, e.g. /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Optional path on ogdeveloper Agent machine, e.g. /etc/krb5.conf",
    kafkaKerberosPathHint: "The keytab and krb5.conf paths are read by ogdeveloper Agent and must exist on the machine running ogdeveloper Agent; files are not uploaded from this browser.",
    ...
    gaussdbConnectionModeNativeHint: "Uses ogdeveloper's built-in PostgreSQL-compatible protocol for GaussDB A/PG/Oracle compatibility modes.",
    ...
    agentJavaTooOld: "This driver requires Java 21. Use ogdeveloper managed JRE 21 or select a Java 21 executable in Driver Manager.",
    ...
    jdbcPluginHint: "Install the ogdeveloper JDBC plugin first. For drivers with external dependencies, install from Maven in Driver Manager or import the driver and all dependency JARs together.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} SQL tabs you are closing have unsaved changes. ogdeveloper is currently showing "{title}". Save before continuing?',
    unsavedChangesAppCloseMessage: '"{title}" has unsaved SQL changes that will be lost if you quit ogdeveloper. Save before quitting?',
    unsavedChangesAppCloseMultipleMessage: '{count} SQL tabs have unsaved changes. ogdeveloper is currently showing "{title}". Save before quitting?',
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "ogdeveloper could not identify exactly one safe writeback target table for this result.",
      ...
      "metadata-unavailable": "ogdeveloper could not load table metadata, so result editing is disabled.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "Encrypted config import is unavailable in this browser context. Use HTTPS, localhost, or ogdeveloper Desktop.",
  ...
  ai: {
    ...
    codexCliEnvReservedName: "{name} is managed by ogdeveloper for the MCP server and cannot be set here.",
    ...
    cliEnvReservedName: "{name} is managed by ogdeveloper for the MCP server and cannot be set here.",
    codexMcpRequiredTitle: "ogdeveloper MCP Server required",
    codexMcpRequiredDescription: "Codex CLI uses the ogdeveloper MCP Server to access database schema and query tools. Install it before using Codex in the AI assistant.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "A ogdeveloper-managed MCP environment variable was overridden. Remove DBX_MCP_* variables from the provider configuration.",
      claudeCodeNotAuthenticated: "Claude Code CLI is not authenticated. Run `claude auth login` in a terminal and try again.",
      claudeCodeMcpConfigInvalid: "Claude Code could not read or parse the ogdeveloper MCP configuration. Check the Claude Code CLI version and executable path.",
      dbxMcpMissing: "A compatible ogdeveloper MCP Server installation was not found. Check Settings > MCP, then reinstall or update it.",
      claudeCodeMcpStartupFailed: "Claude Code loaded the MCP configuration but could not start ogdeveloper MCP Server. Check Settings > MCP and the diagnostics below.",
      claudeCodeCommandLineTooLong: "Windows rejected the Claude Code command because it was too long. Update ogdeveloper and retry using the generated MCP configuration file.",
      ...
      piAgentEnvReserved: "A ogdeveloper-managed Pi or MCP environment variable was overridden. Remove DBX_PI_* and DBX_MCP_* variables from the provider configuration.",
      ...
      piAgentMcpStartupFailed: "Pi could not start the scoped ogdeveloper MCP bridge. Check Settings > MCP and the diagnostics below.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "When DEFAULT is checked, ogdeveloper omits that argument so the database uses the procedure default.",
  ...
  etcd: {
    ...
    access: {
      ...
      permissionUpdateHint: "etcd Auth has no atomic update. Saving revokes the old permission and then grants the new one. If granting fails, ogdeveloper attempts to restore the old permission.",
      saveChanges: "Save changes",
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "Cluster status remains available. ogdeveloper requests /metrics directly from the current etcd endpoint; verify that the resulting URL is reachable from the ogdeveloper application.",
  ...
  sqlParameters: {
    ...
    description: "Fill values for SQL template placeholders. ogdeveloper replaces them before executing the SQL.",
    name: "Parameter",
    syntax: "Syntax",
    type: "Type",
    value: "Value",
  ...
  settings: {
    ...
    aboutTab: "About",
    aboutDescription: "A dedicated database development tool for openGauss. Built on ogdeveloper, ships the official JDBC driver, and provides integrated PL/SQL development, debugging, and object management.",
    ...
    uiFontAppDefault: "ogdeveloper Default",
    ...
    iconThemeDefaultDescription: "Use the color ogdeveloper app icon.",
    iconThemeBlack: "Black",
    iconThemeBlackDescription: "Use the black ogdeveloper logo in the app.",
    ...
    showTrayIconDescription: "When disabled, no icon is shown, but closing the window still hides ogdeveloper in the background as before.",
    quitOnClose: "Quit when closing window",
    quitOnCloseDescription: "When enabled, clicking the close button exits ogdeveloper completely instead of hiding it to the tray. You can change this later in Appearance settings.",
    ...
    closeActionQuit: "Quit ogdeveloper",
    closeActionMinimize: "Minimize to tray",
    updateNotificationsEnabled: "Enable update reminders",
    updateNotificationsEnabledDescription: "When disabled, ogdeveloper will not automatically check app or driver updates or show update badges. Manual checks are still available.",
    ...
    duckDbWorkerProcessIsolationDescription: "Runs DuckDB queries in a separate worker process. If a long query does not respond to cancellation, ogdeveloper can stop the worker process to release the database file lock.",
    duckDbWorkerMaxProcesses: "DuckDB max concurrent workers",
    duckDbWorkerMaxProcessesDescription: "Limits how many DuckDB worker processes ogdeveloper can run at the same time. Range: 1-16. Default: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Restart ogdeveloper for this change to take effect.",
    restartDbx: "Restart ogdeveloper",
    restartDbxFailed: "Failed to restart ogdeveloper: {error}",
    ...
    openTabsRestoreModeDescription: "Choose how ogdeveloper restores tabs that were open last time.",
    ...
    sqlVariableSyntaxDescription: "Choose which variable and placeholder syntaxes ogdeveloper substitutes before running SQL, per database type. All are enabled by default.",
    ...
    jdbcPlugin: "ogdeveloper JDBC plugin",
    ...
    supportInfoAppVersion: "ogdeveloper Version",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "Failed to remove the old JRE directory: {path}\nPossible causes:\n  - a ogdeveloper Agent / java process still holds the directory\n  - antivirus software is scanning it\nClose any process that may hold the directory, or restart ogdeveloper and try again.\n(original error: {error})",
    ...
    javaRuntimeManaged: "ogdeveloper managed JRE",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "Scheduled backups run while ogdeveloper is open, including when it is minimized to the tray.",
