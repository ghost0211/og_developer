...
export default withEnglishFallback({
  ...
  connection: {
    ...
    recognizeTab: "Reconocimiento automático",
    recognizeHint: "Pegue el texto de configuración existente (URL JDBC, pares clave=valor o cualquier descripción) abajo; el modelo de IA por defecto lo analizará y rellenará el formulario de Información de conexión.",
    recognizePlaceholder: "p. ej. jdbc:opengauss://192.168.1.10:5432/postgres?user=gaussdb&password=xxx o host=... port=... user=... password=... database=...",
    recognizeButton: "Reconocer y rellenar",
    recognizeNoConfig: "No hay ningún modelo de IA configurado. Configúrelo en Ajustes → IA primero.",
    recognizeEmptyInput: "Pegue primero el texto de configuración a reconocer.",
    recognizeSuccess: "Reconocido y rellenado. Revise y pruebe la conexión.",
    recognizeSuccessHint: "Reconocido ✓ revíselo antes de conectar",
    recognizeInvalidOutput: "La salida del modelo no contenía un objeto JSON válido",
  ...
  ai: {
    ...
    promptTemplateBuiltin: "Integrado",
    ...
    actions: {
      ...
      generatePlsql: "Generar PL/SQL",
      fixPlsqlError: "Corregir error PL/SQL",
  ...
  contextMenu: {
    ...
    dropSequence: "Eliminar secuencia",
    dropSynonym: "Eliminar sinónimo",
    dropPackage: "Eliminar paquete",
    dropPackageBody: "Eliminar cuerpo de paquete",
    dropType: "Eliminar tipo",
    dropTypeBody: "Eliminar cuerpo de tipo",
    dropJob: "Eliminar trabajo",
    ...
    confirmDropSequenceTitle: "Eliminar secuencia",
    confirmDropSequenceMessage: '¿Seguro que deseas eliminar la secuencia "{name}"?',
    confirmDropSynonymTitle: "Eliminar sinónimo",
    confirmDropSynonymMessage: '¿Seguro que deseas eliminar el sinónimo "{name}"?',
    confirmDropPackageTitle: "Eliminar paquete",
    confirmDropPackageMessage: '¿Seguro que deseas eliminar el paquete "{name}"?',
    confirmDropTypeTitle: "Eliminar tipo",
    confirmDropTypeMessage: '¿Seguro que deseas eliminar el tipo "{name}"?',
    confirmDropJobTitle: "Eliminar trabajo",
    confirmDropJobMessage: '¿Seguro que deseas eliminar el trabajo "{name}"?',
    ...
    dropSequenceSuccess: 'Secuencia "{name}" eliminada',
    dropSynonymSuccess: 'Sinónimo "{name}" eliminado',
    dropPackageSuccess: 'Paquete "{name}" eliminado',
    dropPackageBodySuccess: 'Cuerpo de paquete "{name}" eliminado',
    dropTypeSuccess: 'Tipo "{name}" eliminado',
    dropTypeBodySuccess: 'Cuerpo de tipo "{name}" eliminado',
    dropJobSuccess: 'Trabajo "{name}" eliminado',
  ...
  plDebug: {
    ...
    finished: "Finalizado",
    error: "Error",
    starting: "Iniciando sesión de depuración...",
    continue: "Continuar",
    next: "Paso siguiente",
    step: "Paso a paso (entrar)",
    finish: "Paso a paso (salir)",
    refresh: "Actualizar",
    stop: "Detener depuración",
    currentLine: "Línea {line}",
    locals: "Variables",
    noLocals: "Sin variables",
    backtrace: "Pila de llamadas",
    breakpoints: "Puntos de interrupción",
    noBreakpoints: "Haz clic a la izquierda de un número de línea para añadir un punto de interrupción",
    constVar: "Las constantes son de solo lectura",
    editVar: "Haz clic para editar el valor",
    setVarFailed: "Error al establecer la variable {name}",
  },
  about: {
