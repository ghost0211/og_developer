...
export default withEnglishFallback({
  ...
  updates: {
    ...
    availableMessage: "ogdeveloper {latest} está disponible. Estás usando la versión {current}.",
    upToDate: "ogdeveloper está actualizado ({version}).",
    ...
    activeTasksBlockUpdate: "Hay {count} tarea(s) en ejecución. Espera a que terminen antes de actualizar ogdeveloper.",
    portableAutomaticUpdate: "ogdeveloper descargará el ZIP portable firmado, reemplazará solo ogdeveloper.exe después de salir y se reiniciará automáticamente. portable.ogdeveloper y data se conservarán.",
  ...
  sidebar: {
    ...
    importDbx: "Importar configuración ogdeveloper",
  ...
  connection: {
    ...
    oracleTnsPathHint: "La ruta la lee el backend de ogdeveloper/Oracle Agent. En escritorio es local; en Web y Docker pertenece al servidor.",
    ...
    gaussdbConnectionModeNativeHint: "Usa el protocolo compatible con PostgreSQL integrado en ogdeveloper para los modos A/PG/Oracle de GaussDB.",
    ...
    agentJavaTooOld: "Este controlador requiere Java 21. Use el JRE 21 administrado por ogdeveloper o seleccione un ejecutable Java 21 en el Administrador de controladores.",
    ...
    jdbcPluginHint: "Instala primero el plugin JDBC de ogdeveloper y luego importa el JAR del driver JDBC del proveedor.",
    ...
    kafkaKerberosKeytabPlaceholder: "Ruta en la máquina donde se ejecuta ogdeveloper Agent, por ejemplo /etc/security/keytabs/user.keytab",
    kafkaKerberosKrb5ConfPlaceholder: "Opcional, ruta en la máquina donde se ejecuta ogdeveloper Agent, por ejemplo /etc/krb5.conf",
    kafkaKerberosPathHint: "Las rutas de keytab y krb5.conf son leídas por ogdeveloper Agent y deben existir en la máquina donde se ejecuta ogdeveloper Agent; no se subirán archivos desde el navegador actual.",
  ...
  editor: {
    ...
    unsavedChangesBatchCloseMultipleMessage: '{count} pestañas SQL que vas a cerrar tienen cambios sin guardar. ogdeveloper muestra actualmente "{title}". ¿Guardar antes de continuar?',
    unsavedChangesAppCloseMessage: '"{title}" tiene cambios SQL sin guardar que se perderán si sales de ogdeveloper. ¿Guardar antes de salir?',
    unsavedChangesAppCloseMultipleMessage: '{count} pestañas SQL tienen cambios sin guardar. ogdeveloper muestra actualmente "{title}". Se perderán si sales de ogdeveloper. ¿Guardar antes de salir?',
  ...
  grid: {
    ...
    queryEditUnsupported: {
      ...
      "complex-source": "ogdeveloper no pudo identificar exactamente una tabla de destino segura para escribir este resultado.",
      ...
      "metadata-unavailable": "ogdeveloper no pudo cargar los metadatos de la tabla, por lo que la edición de resultados está deshabilitada.",
    },
  ...
  configExport: {
    ...
    cryptoUnavailable: "La importación cifrada no está disponible en este navegador. Usa HTTPS, localhost o ogdeveloper Desktop.",
  ...
  ai: {
    ...
    codexMcpRequiredTitle: "Se requiere ogdeveloper MCP Server",
    codexMcpRequiredDescription: "Codex CLI usa ogdeveloper MCP Server para acceder al esquema de la base de datos y a las herramientas de consulta. Instálalo antes de usar Codex en el asistente de IA.",
    ...
    codexCliEnvReservedName: "{name} lo administra ogdeveloper para MCP Server y no se puede configurar aquí.",
    ...
    cliErrors: {
      ...
      claudeCodeEnvReserved: "Se sobrescribió una variable MCP administrada por ogdeveloper. Elimina las variables DBX_MCP_* de la configuración del proveedor.",
      ...
      claudeCodeMcpConfigInvalid: "Claude Code no pudo leer o analizar la configuración MCP de ogdeveloper. Comprueba la versión y la ruta del ejecutable de Claude Code CLI.",
      dbxMcpMissing: "No se encontró una instalación compatible de ogdeveloper MCP Server. Comprueba Configuración > MCP y vuelve a instalarla o actualizarla.",
      claudeCodeMcpStartupFailed: "Claude Code cargó la configuración MCP, pero no pudo iniciar ogdeveloper MCP Server. Comprueba Configuración > MCP y los detalles siguientes.",
      claudeCodeCommandLineTooLong: "Windows rechazó el comando de Claude Code porque era demasiado largo. Actualiza ogdeveloper y vuelve a intentarlo con el archivo MCP generado.",
      ...
      piAgentEnvReserved: "Se sobrescribió una variable de Pi o MCP administrada por ogdeveloper. Elimina DBX_PI_* y DBX_MCP_* de la configuración.",
      ...
      piAgentMcpStartupFailed: "Pi no pudo iniciar el puente MCP de ogdeveloper. Comprueba Configuración > MCP y los detalles siguientes.",
  ...
  contextMenu: {
    ...
    parameterDefaultHint: "Cuando DEFAULT está marcado, ogdeveloper omite ese argumento para que la base de datos use el valor predeterminado.",
  ...
  etcd: {
    ...
    dashboard: {
      ...
      metricsUnavailableHint: "El estado del clúster sigue disponible. ogdeveloper solicita /metrics directamente al endpoint de etcd actual; comprueba que la URL resultante sea accesible desde ogdeveloper.",
  ...
  sqlParameters: {
    ...
    description: "Completa valores para marcadores de plantilla SQL. ogdeveloper los reemplaza antes de ejecutar el SQL.",
    name: "Parámetro",
    syntax: "Sintaxis",
    type: "Tipo",
    value: "Valor",
  ...
  settings: {
    ...
    uiFontAppDefault: "Predeterminada de ogdeveloper",
    ...
    iconThemeDefaultDescription: "Usar el icono de color de ogdeveloper.",
    iconThemeBlack: "Negro",
    iconThemeBlackDescription: "Usa el logo negro de ogdeveloper en la aplicación.",
    ...
    showTrayIconDescription: "Si está desactivado, no se muestra el icono, pero cerrar la ventana sigue ocultando ogdeveloper en segundo plano como antes.",
    quitOnClose: "Salir al cerrar la ventana",
    quitOnCloseDescription: "Si está activado, al pulsar el botón de cerrar ogdeveloper se cierra por completo en lugar de ocultarse en la bandeja.",
    ...
    closeActionQuit: "Salir de ogdeveloper",
    closeActionMinimize: "Minimizar a la bandeja",
    updateNotificationsEnabled: "Activar recordatorios de actualización",
    updateNotificationsEnabledDescription: "Al desactivarlo, ogdeveloper no comprobará automáticamente actualizaciones de la app ni de los controladores, ni mostrará indicadores. Las comprobaciones manuales siguen disponibles.",
    ...
    duckDbWorkerProcessIsolationDescription: "Ejecuta las consultas de DuckDB en un proceso worker independiente. Si una consulta larga no responde a la cancelación, ogdeveloper puede detener el proceso worker para liberar el bloqueo del archivo de base de datos.",
    duckDbWorkerMaxProcesses: "Workers concurrentes máximos de DuckDB",
    duckDbWorkerMaxProcessesDescription: "Limita cuántos procesos worker de DuckDB puede ejecutar ogdeveloper al mismo tiempo. Rango: 1-16. Predeterminado: 4.",
    duckDbWorkerProcessIsolationRestartRequired: "Reinicia ogdeveloper para que este cambio surta efecto.",
    restartDbx: "Reiniciar ogdeveloper",
    restartDbxFailed: "No se pudo reiniciar ogdeveloper: {error}",
    ...
    openTabsRestoreModeDescription: "Elige cómo ogdeveloper restaura las pestañas que estaban abiertas la última vez.",
    ...
    syncWebDavDescription: "Sube o restaura una instantánea de ogdeveloper, incluida la biblioteca SQL guardada, desde almacenamiento compatible con WebDAV.",
    ...
    syncRemotePathDescription: "ogdeveloper creará las carpetas padre faltantes al subir.",
    syncSecretNotice: "De forma predeterminada, ogdeveloper solo sincroniza detalles de conexión y ajustes. Las contraseñas de base de datos, SSH, proxy, cadenas de conexión y API keys de IA quedan locales.",
    syncSecrets: "Sincronizar secretos cifrados",
    syncSecretsDescription: "Al activarlo, ogdeveloper cifra contraseñas de base de datos, contraseñas SSH y API keys de IA antes de subirlas a WebDAV.",
    syncSecretsPassphrase: "Contraseña de sync",
    syncSecretsPassphraseDescription: "Esta contraseña solo se usa para cifrar y restaurar datos sensibles. ogdeveloper no la guarda; tendrás que ingresarla en cada dispositivo.",
    syncTest: "Probar",
    syncUpload: "Subir",
    ...
    syncAutoUploadDescription: "Se ejecuta mientras ogdeveloper está abierto. Las descargas aún requieren confirmación manual para evitar reemplazar SQL guardado localmente.",
    ...
    syncDownloadConfirm: "¿Descargar y aplicar la instantánea remota de ogdeveloper? Se reemplazarán metadatos locales y SQL guardado.",
    apply: "Aplicar",
    ...
    sqlVariableSyntaxDescription: "Elige qué sintaxis de variables y marcadores sustituye ogdeveloper antes de ejecutar SQL, por tipo de base de datos. Todas están habilitadas de forma predeterminada.",
    ...
    jdbcPlugin: "Plugin JDBC de ogdeveloper",
    ...
    mcpTitle: "MCP Server",
    mcpDescription: "Comprueba la instalación y versión de ogdeveloper MCP Server para Claude Code, Cursor y otros agentes.",
    ...
    mcpConfigOptionsHint:
      "ogdeveloper controla de forma central el acceso a conexiones y los permisos de ejecución para todos los clientes MCP. La configuración generada solo contiene los parámetros de ejecución necesarios para iniciar el servidor MCP y conectarlo a esta instancia de ogdeveloper, sin variables de permisos ni de ámbito de conexión.",
    mcpScopeConnection: "Conexiones permitidas para MCP",
    mcpScopeConnectionDescription: "ogdeveloper solo expone a MCP las conexiones seleccionadas. Los cambios se aplican a todos los clientes MCP.",
    ...
    mcpExecutionModeDescription: "Elige el nivel de permiso que ogdeveloper aplica a todos los clientes MCP. La configuración de lectura y escritura del cliente no puede cambiar este nivel.",
    ...
    mcpExecutionModeReadOnlyDescription: "Solo permite solicitudes que ogdeveloper clasifica como lecturas; bloquea las escrituras reconocidas y los cambios de conexión. Los permisos de la cuenta de base de datos siguen siendo el límite de seguridad final.",
    ...
    mcpCapabilityDescription: "Estas son operaciones representativas; las solicitudes que ogdeveloper no puede clasificar de forma fiable requieren acceso completo.",
    ...
    mcpDetectionTiming: "ogdeveloper comprueba automáticamente al abrir esta página; usa Comprobar de nuevo para actualizar.",
    mcpNpmBoundary: "ogdeveloper solo comprueba y explica el estado de MCP; la instalación y actualización siguen usando npm.",
    ...
    supportInfoAppVersion: "Versión de ogdeveloper",
    ...
    syncSnippetMigrateLegacyConfirm: "ogdeveloper creará primero un reemplazo cifrado y después eliminará permanentemente el fragmento heredado de texto sin cifrar {id}. Esta acción no se puede deshacer. ¿Continuar?",
  ...
  driverStore: {
    ...
    jreDirRemoveFailedWindows:
      "No se pudo eliminar el directorio JRE antiguo: {path}\nCausas posibles:\n  - un proceso ogdeveloper Agent / java sigue usando el directorio\n  - el antivirus lo está analizando\nCierre cualquier proceso que pueda estar usando el directorio, o reinicie ogdeveloper e inténtelo de nuevo.\n(error original: {error})",
    ...
    javaRuntimeManaged: "JRE administrado por ogdeveloper",
  ...
  databaseBackup: {
    ...
    runtimeRequirement: "ogdeveloper ejecutará copias de seguridad programadas cuando esté abierto, incluso cuando esté minimizado en la bandeja.",
  ...
  mqExchanges: {
    ...
    namePlaceholder: "p. ej. my-events",
    cancel: "Cancelar",
    create: "Crear",
    bind: "Vincular",
    bindDialogTitle: "Vincular a {name}",
    queueNamePlaceholder: "p. ej. my-queue",
    exchangeNamePlaceholder: "p. ej. my-events",
