...
const patterns: [RegExp, string][] = [
  ...
  // Query result export limits (crates/ogdeveloper-core/src/query_result_export.rs)
  ...
  // Driver / JRE management (crates/ogdeveloper-core/src/agent_service.rs, routes/agents.rs)
  ...
  // Message queues (crates/ogdeveloper-core/src/mq/adapters/kafka.rs)
  ...
  // Web auth rate limiting (crates/ogdeveloper-web/src/auth.rs)
