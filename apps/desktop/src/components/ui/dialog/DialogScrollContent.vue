  ...
  <DialogPortal>
    ...
    <div class="fixed inset-0 z-50 grid place-items-center p-4 pointer-events-none">
      <DialogContent
        ...
        :class="cn('relative z-50 grid max-h-[calc(var(--ogdeveloper-viewport-height)-6rem)] w-full max-w-lg my-8 gap-4 rounded-lg border border-border bg-background p-4 shadow-lg duration-200 md:w-full pointer-events-auto', props.class)"
