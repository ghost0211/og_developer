...
function columnPlaceholderValue(column: ColumnInfo, databaseType?: DatabaseType): string {
  ...
  if (typeLooksBoolean(dataType)) return "TRUE";
  ...
  if (typeLooksJson(dataType)) return databaseType === "postgres" ? "'{}'::jsonb" : "'{}'";
  if (typeLooksBinary(dataType)) return "''";
  if (typeLooksUuid(dataType)) return databaseType === "postgres" ? "'00000000-0000-0000-0000-000000000000'::uuid" : "'00000000-0000-0000-0000-000000000000'";
