export interface EncryptedPayload {
  format: "ogdeveloper-encrypted" | "dbx-encrypted";
  version: 1;
  salt: string;
  iv: string;
  data: string;
...
export interface PlainConfigPayload {
  format: "ogdeveloper-config" | "dbx-config";
  version: 1;
  connections: unknown[];
}
...
export function isEncryptedConfig(data: unknown): data is EncryptedPayload {
  ...
  return (obj.format === "ogdeveloper-encrypted" || obj.format === "dbx-encrypted") && obj.version === 1 && typeof obj.salt === "string" && typeof obj.iv === "string" && typeof obj.data === "string";
}
