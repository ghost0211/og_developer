...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::opengauss_debug::opengauss_debug_start,
            commands::opengauss_debug::opengauss_debug_step,
            commands::opengauss_debug::opengauss_debug_locals,
            commands::opengauss_debug::opengauss_debug_set_var,
            commands::opengauss_debug::opengauss_debug_backtrace,
            commands::opengauss_debug::opengauss_debug_breakpoints,
            commands::opengauss_debug::opengauss_debug_add_breakpoint,
            commands::opengauss_debug::opengauss_debug_delete_breakpoint,
            commands::opengauss_debug::opengauss_debug_toggle_breakpoint,
            commands::opengauss_debug::opengauss_debug_stop,
            commands::opengauss_debug::opengauss_debug_call_result,
