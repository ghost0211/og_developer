...
const capabilities = {
  en: [
    ...
    { icon: FileCode, label: "Built on the OG Developer workbench: editor, grid, tunnels, and more" },
  ],
  cn: [
    ...
    { icon: FileCode, label: "基于 OG Developer 工作台：编辑器、数据网格、隧道等一应俱全" },
  ],
};

const i18nText = {
  en: {
    heroTitle: "openGauss Database Development Tool",
    heroSubtitle: "One database, done right: PL/SQL splitting, A-compatibility types, a graphical debugger, and message capture — on top of the OG Developer workbench.",
  ...
  cn: {
    ...
    heroSubtitle: "只做一种数据库，做到极致：PL/SQL 切分、A 兼容类型、图形调试器、消息捕获——构建在 OG Developer 工作台之上。",
    readDocs: "查看文档",
    docsStart: "从这里开始",
...
const landingMeta = {
  en: {
    title: "OG Developer — An openGauss Database Development Tool",
    description: "An openGauss-specific database development tool: PL/SQL splitting, A-compatibility types, graphical debugger, and message capture, on top of the OG Developer workbench.",
  },
  cn: {
    title: "OG Developer — openGauss 专用数据库开发工具",
    description: "openGauss 专用数据库开发工具：PL/SQL 切分、A 兼容类型、图形调试器与消息捕获，构建在 OG Developer 工作台之上。",
  },
};
      ...
      <section className="landing-hero" aria-labelledby="landing-title">
        ...
        <div className="relative z-[1] max-w-[1180px] mx-auto px-7 max-[1040px]:max-w-[920px] max-[760px]:px-[18px]">
          <div className="landing-hero-copy relative z-[6] grid justify-items-center max-w-[900px] mx-auto text-center max-[1040px]:max-w-[760px]">
            <h1 id="landing-title" className="min-w-0 m-0 text-[clamp(36px,4.2vw,56px)] font-[820] leading-[1.06] text-landing-ink max-[760px]:max-w-[12ch] max-[760px]:text-[clamp(29px,8.7vw,38px)] max-[760px]:leading-[1.08] max-[760px]:text-balance">
              {t.heroTitle}
            </h1>
