...
Snippets are editor settings stored in the current DBX runtime. [Connection Config Migration](/en/docs/config-export) only moves database connections and does not include snippets.
