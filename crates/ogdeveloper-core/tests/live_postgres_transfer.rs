...
use ogdeveloper_core::transfer::{get_db_type, transfer_table, TransferMode, TransferRequest, TransferTableNameCase};
use serde_json::json;
...
async fn live_postgres_transfer_preserves_data_and_schema_objects() {
    ...
    let request = TransferRequest {
        ...
        content: ogdeveloper_core::transfer::TransferContent::default(),
        objects: Vec::new(),
    ...
    ogdeveloper_core::transfer::transfer_schema_objects(&state, &request, &source_pool_key, &target_pool_key, |_| {})
        .await
        .unwrap();
