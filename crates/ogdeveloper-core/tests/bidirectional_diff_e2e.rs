...
use ogdeveloper_core::schema_diff::{
    prepare_schema_diff, RollbackGraph, SchemaDiffPreparationOptions, TableSchemaDetail,
};
...
fn rollback_graph_direct_consistency_check() {
    use ogdeveloper_core::schema_diff::DependencyGraph;

    let forward_diff = ogdeveloper_core::schema_diff::TableDiff {
