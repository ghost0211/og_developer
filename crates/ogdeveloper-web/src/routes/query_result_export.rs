...
use ogdeveloper_core::query_result_export::{self, QueryResultExportRequest};
use ogdeveloper_core::table_export::{ExportStatus, TableExportProgress};
...
pub async fn start_query_result_export(
    ...
    tokio::spawn(async move {
        ...
        ogdeveloper_core::database_export::clear_export_cancelled(&req.export_id).await;
...
pub async fn cancel_query_result_export(
    ...
    ogdeveloper_core::database_export::set_export_cancelled(&req.export_id).await;
