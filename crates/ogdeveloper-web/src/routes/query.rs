...
pub struct ExecuteQueryRequest {
    ...
    pub execution_mode: Option<ogdeveloper_core::query::QueryExecutionMode>,
}
...
pub struct FindStatementAtCursorRequest {
    ...
    pub database_type: Option<ogdeveloper_core::models::connection::DatabaseType>,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareQueryPaginationExecutionPlanRequest {
    pub options: ogdeveloper_core::query_result_sql::QueryPaginationExecutionPlanOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSortedQuerySqlRequest {
    pub options: ogdeveloper_core::query_result_sql::SortedQuerySqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExplainSqlRequest {
    pub options: ogdeveloper_core::query_execution_sql::ExplainSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDroppedFilePreviewSqlRequest {
    pub options: ogdeveloper_core::query_execution_sql::DroppedFilePreviewSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableSelectSqlRequest {
    pub options: ogdeveloper_core::sql_dialect::TableDataSelectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseSearchSqlRequest {
    pub options: ogdeveloper_core::database_search_sql::DatabaseSearchSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSearchResultWhereRequest {
    pub options: ogdeveloper_core::database_search_sql::SearchResultWhereOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRenameObjectSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::RenameObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildCreateDatabaseSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::CreateDatabaseSqlOptions,
}
...
pub struct BuildSqliteAttachDatabaseSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::SqliteAttachDatabaseSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropObjectSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::DropObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableAdminSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::TableAdminSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDropTableChildObjectSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::DropTableChildObjectSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseNameSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::DatabaseNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildSchemaNameSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::SchemaNameSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabasePropertyEditSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::DatabasePropertyEditSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDuplicateTableStructureSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::DuplicateTableStructureSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildCopyTableDataSqlRequest {
    pub options: ogdeveloper_core::db_admin_sql::CopyTableDataSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExecutableObjectSourceRequest {
    pub input: ogdeveloper_core::object_source_sql::EditableObjectSourceSqlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildRoutineRenameObjectSourceRequest {
    pub input: ogdeveloper_core::object_source_sql::RoutineRenameObjectSourceInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildViewDdlRequest {
    pub input: ogdeveloper_core::object_source_sql::BuildViewDdlInput,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildTableStructureSqlRequest {
    pub options: ogdeveloper_core::table_structure_sql::TableStructureSqlOptions,
}
...
pub struct BuildSingleColumnAlterSqlRequest {
    pub options: ogdeveloper_core::table_structure_sql::SingleColumnAlterSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct PrepareDataGridSaveRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridSaveStatementOptions,
}

#[derive(Deserialize, utoipa::ToSchema)]
#[serde(rename_all = "camelCase")]
pub struct ExtractDataGridSelectionRequest {
    pub request: ogdeveloper_core::data_grid_extractors::DataGridExtractRequest,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyUpdateStatementsRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridCopyUpdateStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCopyInsertStatementRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridCopyInsertStatementOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridContextFilterConditionRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridContextFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnValueFilterConditionRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridColumnValueFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnValuesFilterConditionRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridColumnValuesFilterConditionOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridColumnDistinctValuesSqlRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridColumnDistinctValuesSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDataGridCountSqlRequest {
    pub options: ogdeveloper_core::data_grid_sql::DataGridCountSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildHiveTablePropertiesSqlRequest {
    pub options: ogdeveloper_core::data_grid_sql::HiveTablePropertiesSqlOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportInsertStatementsRequest {
    pub options: ogdeveloper_core::database_export::BuildExportInsertStatementsOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildExportSqlInsertRequest {
    pub options: ogdeveloper_core::database_export::BuildExportSqlInsertOptions,
}

#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct BuildDatabaseSqlExportRequest {
    pub options: ogdeveloper_core::database_export::BuildDatabaseSqlExportOptions,
}
...
) -> Result<Json<ogdeveloper_core::db::QueryResult>, AppError> {
...
pub async fn execute_multi(
    ...
    headers: HeaderMap,
    Json(req): Json<ExecuteQueryRequest>,
) -> Result<Json<Vec<ogdeveloper_core::query::ExecuteMultiResult>>, AppError> {
    let allow_database_switch = req.client_session_id.as_deref().is_some_and(|id| !id.trim().is_empty());
    super::mcp_policy::ensure_sql(&state, &headers, &req.connection_id, &req.database, &req.sql, allow_database_switch)
        .await?;
    let execution_id = req.execution_id.unwrap_or_else(|| uuid::Uuid::new_v4().to_string());
    ...
    let result = ogdeveloper_core::query::execute_multi_core_with_options_for_client_typed(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.sql,
...
fn execute_multi_response(
    result: Vec<ogdeveloper_core::query::ExecuteMultiResult>,
) -> Json<Vec<ogdeveloper_core::query::ExecuteMultiResult>> {
    Json(result)
}
...
pub async fn execute_batch(
...
) -> Result<Json<Vec<ogdeveloper_core::db::QueryResult>>, AppError> {
    ...
    let result = ogdeveloper_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
pub async fn execute_script(
    ...
    let statements = db_type
        .map(|db_type| ogdeveloper_core::sql::split_sql_statements_for_database(&req.sql, db_type))
        .unwrap_or_else(|| ogdeveloper_core::sql::split_sql_statements(&req.sql));
    let result = ogdeveloper_core::query::execute_statements(
        &state.app,
        &req.connection_id,
        &req.database,
...
pub async fn execute_in_transaction(
    ...
    let result = ogdeveloper_core::query::execute_statements_in_transaction(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
pub async fn execute_script_with_2pc(
    State(state): State<Arc<WebState>>,
    Json(req): Json<ExecuteBatchRequest>,
) -> Result<Json<ogdeveloper_core::query::SchemaDiffDeployResult>, AppError> {
    ...
    let result = ogdeveloper_core::query::execute_schema_diff_deploy(
        &state.app,
        &req.connection_id,
        &req.database,
        &req.statements,
...
) -> Result<Json<ogdeveloper_core::sql_analysis::SqlReferenceAnalysis>, AppError> {
    ogdeveloper_core::sql_analysis::analyze_sql_references(&req.sql, req.dialect.as_deref())
        .map(Json)
        .map_err(AppError::from)
}
...
pub async fn find_statement_at_cursor(Json(req): Json<FindStatementAtCursorRequest>) -> Json<String> {
    Json(
        req.database_type
            .map(|db_type| {
                ogdeveloper_core::sql::find_statement_at_cursor_for_database(&req.sql, req.cursor_pos, db_type)
            })
            .unwrap_or_else(|| ogdeveloper_core::sql::find_statement_at_cursor(&req.sql, req.cursor_pos)),
    )
}

pub async fn prepare_query_pagination_execution_plan(
    Json(req): Json<PrepareQueryPaginationExecutionPlanRequest>,
) -> Json<ogdeveloper_core::query_result_sql::QueryPaginationExecutionPlan> {
    Json(ogdeveloper_core::query_result_sql::build_query_pagination_execution_plan(req.options))
}

pub async fn build_sorted_query_sql(
    Json(req): Json<BuildSortedQuerySqlRequest>,
) -> Json<ogdeveloper_core::query_result_sql::QuerySqlBuildResult> {
    Json(ogdeveloper_core::query_result_sql::build_sorted_query_sql(req.options))
}

pub async fn build_explain_sql(
    Json(req): Json<BuildExplainSqlRequest>,
) -> Json<ogdeveloper_core::query_execution_sql::ExplainSqlBuildResult> {
    Json(ogdeveloper_core::query_execution_sql::build_explain_sql(req.options))
}
...
pub async fn build_create_user_sql(Json(req): Json<BuildCreateUserSqlRequest>) -> Result<Json<String>, AppError> {
    Ok(Json(ogdeveloper_core::db_admin_sql::build_create_user_sql(&req.username, &req.password, &req.tablespace)))
}

pub async fn build_dropped_file_preview_sql(
    Json(req): Json<BuildDroppedFilePreviewSqlRequest>,
) -> Json<Option<String>> {
    Json(ogdeveloper_core::query_execution_sql::build_dropped_file_preview_sql(req.options))
}

pub async fn build_table_select_sql(Json(req): Json<BuildTableSelectSqlRequest>) -> Json<String> {
    Json(ogdeveloper_core::sql_dialect::build_table_data_select_sql(req.options))
}

pub async fn build_database_search_sql(
    Json(req): Json<BuildDatabaseSearchSqlRequest>,
) -> Json<Option<ogdeveloper_core::database_search_sql::DatabaseSearchSql>> {
    Json(ogdeveloper_core::database_search_sql::build_database_search_sql(req.options))
}

pub async fn build_search_result_where(Json(req): Json<BuildSearchResultWhereRequest>) -> Json<String> {
    Json(ogdeveloper_core::database_search_sql::build_search_result_where(req.options))
}

pub async fn build_rename_object_sql(Json(req): Json<BuildRenameObjectSqlRequest>) -> Result<Json<String>, AppError> {
    ogdeveloper_core::db_admin_sql::build_rename_object_sql(req.options).map(Json).map_err(AppError::from)
}

pub async fn build_create_database_sql(
    Json(req): Json<BuildCreateDatabaseSqlRequest>,
) -> Result<Json<String>, AppError> {
    ogdeveloper_core::db_admin_sql::build_create_database_sql(req.options).map(Json).map_err(AppError::from)
}
...
pub async fn build_executable_object_source_sql(
    ...
    ogdeveloper_core::object_source_sql::build_executable_object_source_sql(req.input).map(Json).map_err(AppError::from)
}

pub async fn build_editable_object_source(Json(req): Json<BuildExecutableObjectSourceRequest>) -> Json<String> {
    Json(ogdeveloper_core::object_source_sql::build_editable_object_source(req.input))
}

pub async fn build_routine_rename_object_source_statements(
    Json(req): Json<BuildRoutineRenameObjectSourceRequest>,
) -> Result<Json<Vec<String>>, AppError> {
    ogdeveloper_core::object_source_sql::build_routine_rename_object_source_statements(req.input)
        .map(Json)
        .map_err(AppError::from)
}

pub async fn build_view_ddl_sql(Json(req): Json<BuildViewDdlRequest>) -> Json<String> {
    Json(ogdeveloper_core::object_source_sql::build_view_ddl_sql(req.input))
}

pub async fn build_table_structure_change_sql(
    Json(req): Json<BuildTableStructureSqlRequest>,
) -> Json<ogdeveloper_core::table_structure_sql::TableStructureSqlResult> {
    Json(ogdeveloper_core::table_structure_sql::build_table_structure_change_sql(req.options))
}
...
) -> Result<Json<ogdeveloper_core::table_structure_sql::SqliteTableStructurePreview>, AppError> {
...
pub async fn build_create_table_sql(
    ...
    Json(ogdeveloper_core::table_structure_sql::build_create_table_sql(req.options))
}

pub async fn build_single_column_alter_sql(
    Json(req): Json<BuildSingleColumnAlterSqlRequest>,
) -> Json<ogdeveloper_core::table_structure_sql::TableStructureSqlResult> {
    Json(ogdeveloper_core::table_structure_sql::build_single_column_alter_sql(req.options))
}

pub async fn analyze_editable_query_editability(
    Json(req): Json<AnalyzeEditableQueryRequest>,
) -> Json<ogdeveloper_core::sql_editability::QueryEditability> {
    Json(ogdeveloper_core::sql_editability::analyze_editable_query_editability(&req.sql))
}

pub async fn prepare_data_grid_save(
    Json(req): Json<PrepareDataGridSaveRequest>,
) -> Json<ogdeveloper_core::data_grid_sql::DataGridSavePreparation> {
    Json(ogdeveloper_core::data_grid_sql::prepare_data_grid_save(req.options))
}
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Selection extracted successfully", body = ogdeveloper_core::data_grid_extractors::DataGridExtractResult),
        (status = 400, description = "Invalid selection or extractor configuration", body = ogdeveloper_core::data_grid_extractors::DataGridExtractError),
        ...
        (status = 500, description = "Extractor worker failed", body = ogdeveloper_core::data_grid_extractors::DataGridExtractError)
    ),
    tag = "data-grid"
)]
pub async fn extract_data_grid_selection(
    ...
    Json<ogdeveloper_core::data_grid_extractors::DataGridExtractResult>,
    (axum::http::StatusCode, Json<ogdeveloper_core::data_grid_extractors::DataGridExtractError>),
> {
    tokio::task::spawn_blocking(move || {
        ogdeveloper_core::data_grid_extractors::extract_data_grid_selection(req.request)
    })
    .await
    .map_err(|error| {
        let error = ogdeveloper_core::data_grid_extractors::DataGridExtractError::new(
...
pub async fn build_database_sql_export(
    ...
    ogdeveloper_core::database_export::build_database_sql_export(options).map(Json).map_err(AppError::from)
}
...
mod tests {
    ...
    async fn test_web_state() -> (Arc<WebState>, std::path::PathBuf) {
        let dir = std::env::temp_dir().join(format!("ogdeveloper-web-query-test-{}", uuid::Uuid::new_v4()));
    ...
    fn execute_multi_response_preserves_nested_original_error_detail() {
        let result = ogdeveloper_core::query::ExecuteMultiResult {
            result: ogdeveloper_core::db::QueryResult {
            ...
            error: Some(ogdeveloper_core::backend_error::BackendError::from_sql_detail(
